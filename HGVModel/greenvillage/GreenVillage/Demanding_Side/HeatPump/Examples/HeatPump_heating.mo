...
model HeatPump_heating
 ...
 package Medium = Buildings.Media.Water "Medium model";
  ...
  Modelica.Blocks.Sources.Constant Speed(k=273.15 + 29.44 + 5)
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souDem(
    ...
    T=285.15) annotation (Placement(transformation(extent={{62,-90},{42,-70}})));
