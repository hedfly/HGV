...
model Water_loop_withResistance
  import GreenVillage;
 ...
 parameter Real pressure[:]={2*3000,3000,0};

  UserSide.UserSide heatPump_with_load_input(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souDem(
    ...
    T=292.59) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={294,-90})));
  UserSide.UserSide heatPump_with_load_input1(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input2(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input3(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input4(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input5(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input6(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input7(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide heatPump_with_load_input8(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
...
equation
  ...
  connect(Speed.y, Pump.y) annotation (Line(
      ...
      pattern=LinePattern.Dash));
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-280,-100},{320,
            100}}),                                                                      graphics),
    experiment(StopTime=1e+006),
    __Dymola_experimentSetupOutput);
end Water_loop_withResistance;
