within GreenVillage.Demanding_Side.Waterloop.Examples;
model Water_loop_withResistance_twolayerspump
  import GreenVillage;
 ...
 parameter Real pressure[:]={2*2000,2000,0};
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide_withPump
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souDem(
    ...
    T=292.59) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={294,-90})));
  UserSide.UserSide_withPump heatPump_with_load_input1(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide_withPump heatPump_with_load_input2(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide_withPump heatPump_with_load_input3(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide_withPump heatPump_with_load_input4(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
    ...
    ti=60,
    TCon_nominal=302.59,
    TEva_nominal=278.15) annotation (Placement(transformation(extent={{-52,40},{-30,64}})));
  UserSide.UserSide_withPump heatPump_with_load_input5(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  UserSide.UserSide_withPump heatPump_with_load_input6(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
    ...
    ti=60,
    TCon_nominal=302.59,
    TEva_nominal=278.15) annotation (Placement(transformation(extent={{36,40},{58,64}})));
  UserSide.UserSide_withPump heatPump_with_load_input7(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
    ...
    ti=60,
    TCon_nominal=302.59,
    TEva_nominal=278.15) annotation (Placement(transformation(extent={{76,40},{98,64}})));
  UserSide.UserSide_withPump heatPump_with_load_input8(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  Buildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
    ...
    m2_flow_nominal=9*heatPump_with_load_input.m1_flow_nominal)
        ...
        rotation=90,
        origin={198,-60})));
  GreenVillage.Buildings.Fluid.Movers.SpeedControlled_y Pump(
    redeclare package Medium = Medium,
    addPowerToMedium=false,
    motorCooledByFluid=false,
    per(pressure(V_flow=v, dp=pressure)))
  ...
  Modelica.Blocks.Sources.Constant Speed(k=1) annotation (Placement(transformation(extent={{186,2},{174,14}})));
...
equation
  ...
  connect(sinDem.ports[1], hex.port_b2) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=1));
  connect(hex.port_b1, Pump.port_a) annotation (Line(
      points={{192,-50},{192,-32},{170,-32}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=1));
  connect(expVesChi.port_a, Pump.port_a) annotation (Line(
  ...
  connect(hex.port_a1, res1.port_b) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=1));
  connect(Pump.port_b, heatPump_with_load_input8.port_a) annotation (Line(
      points={{150,-32},{122.6,-32},{122.6,40}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=1));
  ...
  connect(heatPump_with_load_input5.Q, ramp1.y) annotation (Line(
      ...
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(Speed.y, Pump.y) annotation (Line(
      points={{173.4,8},{160,8},{160,-20}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  annotation (
...
end Water_loop_withResistance_twolayerspump;
