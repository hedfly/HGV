...
model Water_loop_withResistance
 ...
 parameter Real pressure[:]={2*3000,3000,0};
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souDem(
    ...
    T=292.59) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={294,-90})));
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input1(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input2(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input3(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input4(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input5(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input6(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input7(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
  ...
  GreenVillage.Demanding_Side.UserSide.UserSide heatPump_with_load_input8(
    P_nominal=1000,
    dTEva_nominal=7,
    dTCon_nominal=5,
    COPc_nominal=3,
