within GreenVillage.Buildings.BoundaryConditions.WeatherData;
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput HGloHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if (HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2") if (HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor
     or HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
...
protected
  ...
  BaseClasses.CheckSkyCover cheOpaSkyCov "Check the opaque sky cover"
    annotation (Placement(transformation(extent={{162,-158},{182,-138}})));
...
equation
  ...
  if HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor
       or HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
  ...
  if HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor
       or HSou == Buildings.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  connect(cheOpaSkyCov.nOut, weaBus.nOpa) annotation (Line(
      points={{183,-148},{220,-148},{220,0},{300,0}},
      color={0,0,127},
      smooth=Smooth.None), Text(
      string="%second",
      index=1,
  ...
  connect(cheOpaSkyCov.nOut,TBlaSkyCom. nOpa) annotation (Line(
      points={{183,-148},{220,-148},{220,-213},{238,-213}},
      color={0,0,127},
      smooth=Smooth.None));
