within GreenVillage.Buildings.BoundaryConditions.WeatherData.Examples;
model ReaderTMY3 "Test model for reading weather data"
  ...
  Modelica.Blocks.Sources.Constant HDifHor(k=120)
    "Diffuse horizontal radiation"
    annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
  Modelica.Blocks.Sources.Constant HGloHor(k=120) "Horizontal global radiation"
