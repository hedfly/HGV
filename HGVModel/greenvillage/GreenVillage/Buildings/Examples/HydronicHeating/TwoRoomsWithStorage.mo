within GreenVillage.Buildings.Examples.HydronicHeating;
model TwoRoomsWithStorage
 ...
 parameter Modelica.SIunits.Pressure dp_nominal=
  ...
  Buildings.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear thrWayVal(
    ...
    dynamicBalance=false,
    dpFixed_nominal={100,0}) "Three-way valve" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={220,0})));
  ...
  Buildings.Fluid.FixedResistances.FixedResistanceDpM dpFac4(
    ...
    dp_nominal=10) "Pressure drop at facade" annotation (Placement(
        transformation(extent={{-10,-10},{10,10}}, origin={330,216})));
