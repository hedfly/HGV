within GreenVillage.Buildings.Examples.ChillerPlant.BaseClasses.Controls.Examples;
model ChillerSetPointControl
  ...
  Buildings.Controls.Continuous.LimPID limPID(
    ...
    Ti=0.01,
    Td=10,
    initType=Modelica.Blocks.Types.InitPID.SteadyState) annotation (Placement(
        transformation(extent={{-10,-10},{10,10}}, origin={-130,30})));
  ...
  Buildings.Fluid.Sources.FixedBoundary sin2(redeclare package Medium =
        MediumAir, nPorts=1) annotation (Placement(transformation(extent={{-10,
