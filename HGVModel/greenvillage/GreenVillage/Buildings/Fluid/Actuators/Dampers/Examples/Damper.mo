within GreenVillage.Buildings.Fluid.Actuators.Dampers.Examples;
model Damper
  ...
  Buildings.Fluid.Sources.Boundary_pT sou(
    ...
    T=293.15) annotation (Placement(transformation(extent={{-68,10},{-48,30}})));
  Buildings.Fluid.Sources.Boundary_pT sin(
    redeclare package Medium = Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101325,
    T=293.15) annotation (Placement(transformation(extent={{74,10},{54,30}})));
