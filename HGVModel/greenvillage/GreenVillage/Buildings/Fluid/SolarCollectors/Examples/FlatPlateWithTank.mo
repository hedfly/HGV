within GreenVillage.Buildings.Fluid.SolarCollectors.Examples;
model FlatPlateWithTank
  ...
  Buildings.Fluid.Storage.StratifiedEnhancedInternalHex tan(
    ...
    "Storage tank model" annotation (Placement(transformation(extent={{-15,-15},
            {15,15}}, origin={27,-33})));
  ...
  Buildings.Fluid.Sources.Boundary_pT bou(redeclare package Medium = Medium,
      nPorts=1) "Outlet for hot water draw" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=180,
        origin={-12,-30})));
  Buildings.Fluid.Sources.MassFlowSource_T bou1(
    ...
    nPorts=1,
    m_flow=0.001,
    T=288.15) "Inlet and flow rate for hot water draw" annotation (Placement(
        transformation(extent={{10,-10},{-10,10}}, origin={70,-32})));
  ...
  Buildings.Fluid.Storage.ExpansionVessel exp(redeclare package Medium =
        Medium_2, V_start=0.1) "Expansion tank" annotation (Placement(
        transformation(extent={{-10,-10},{10,10}}, origin={-66,-36})));
