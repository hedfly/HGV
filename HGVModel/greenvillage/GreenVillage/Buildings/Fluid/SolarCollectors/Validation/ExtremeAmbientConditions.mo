within GreenVillage.Buildings.Fluid.SolarCollectors.Validation;
model ExtremeAmbientConditions
  "Validation model for to ensure that collectors do not freeze or boil"
  extends Modelica.Icons.Example;

  replaceable package Medium = Buildings.Media.Water (T_min=273.15, T_max=
          273.15 + 100) "Medium in the system";
