within GreenVillage.Buildings.Fluid.FMI.Interfaces;
connector Outlet "Connector for fluid outlet"
  ...
  input Buildings.Fluid.FMI.Interfaces.FluidProperties backward(redeclare
      final package Medium = Medium) if allowFlowReversal
    "Inflowing properties";

  output Buildings.Fluid.FMI.Interfaces.FluidProperties forward(redeclare
      final package Medium = Medium) "Outflowing properties";
