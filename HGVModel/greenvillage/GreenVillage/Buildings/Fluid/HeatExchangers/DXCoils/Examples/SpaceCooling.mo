within GreenVillage.Buildings.Fluid.HeatExchangers.DXCoils.Examples;
model SpaceCooling "Space cooling with DX coils"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.Data.Generic.DXCoil datCoi(sta={
      ...
      nSta=1) annotation (Placement(transformation(extent={{0,-40},{20,-20}})));

  parameter Buildings.Fluid.HeatExchangers.DXCoils.Data.Generic.DXCoil datCoiMulSpe(nSta=2,
      sta={
        Buildings.Fluid.HeatExchangers.DXCoils.Data.Generic.BaseClasses.Stage(
        spe=900/60,
        nomVal=
