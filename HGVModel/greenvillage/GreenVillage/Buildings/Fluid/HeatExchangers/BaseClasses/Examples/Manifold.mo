within GreenVillage.Buildings.Fluid.HeatExchangers.BaseClasses.Examples;
model Manifold "Test model for coil manifold"
 ...
 parameter Integer nPipSeg = 4 "Number of pipe segments";
  ...
  Buildings.Fluid.Sensors.MassFlowRate[nPipPar,nPipSeg] mfr_2(redeclare package
      Medium = Medium2)
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_2(
    ...
    T=283.15,
    redeclare package Medium = Medium2)
    annotation (Placement(transformation(extent={{168,-40},{148,-20}})));
