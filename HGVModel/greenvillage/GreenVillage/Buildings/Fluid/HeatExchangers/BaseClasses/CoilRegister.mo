within GreenVillage.Buildings.Fluid.HeatExchangers.BaseClasses;
model CoilRegister "Register for a heat exchanger"
  import Modelica.Constants;
  extends Buildings.Fluid.Interfaces.FourPortFlowResistanceParameters(final
  ...
  replaceable Buildings.Fluid.HeatExchangers.BaseClasses.HexElementSensible ele[nPipPar,
    nPipSeg] constrainedby
    ...
    initialize_p1={{(i == 1 and j == 1 and initialize_p1) for i in 1:nPipSeg}
        for j in 1:nPipPar},
    initialize_p2={{(i == 1 and j == 1 and initialize_p2) for i in 1:nPipSeg}
        for j in 1:nPipPar},
