within GreenVillage.Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses;
model PipeToSlabConductance
  ...
  parameter Buildings.Fluid.HeatExchangers.RadiantSlabs.Types.HeatTransfer heatTransfer=Buildings.Fluid.HeatExchangers.RadiantSlabs.Types.HeatTransfer.
       EpsilonNTU "Model for heat transfer between fluid and slab";
