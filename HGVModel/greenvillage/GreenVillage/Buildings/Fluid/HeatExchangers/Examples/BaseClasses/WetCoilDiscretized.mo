within GreenVillage.Buildings.Fluid.HeatExchangers.Examples.BaseClasses;
partial model WetCoilDiscretized
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_2(
    redeclare package Medium = Medium2,
    nPorts=1,
    T=293.15) annotation (Placement(transformation(extent={{50,30},{30,50}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    use_T_in=true,
    T=293.15,
    nPorts=1) annotation (Placement(transformation(extent={{-50,60},{-30,80}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_3(
    redeclare package Medium = Medium2,
    nPorts=1,
    T=293.15) annotation (Placement(transformation(extent={{50,-30},{30,-10}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_4(
    ...
    use_T_in=true,
    T=293.15,
    nPorts=1) annotation (Placement(transformation(extent={{-50,0},{-30,20}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_5(
    redeclare package Medium = Medium2,
    nPorts=1,
    T=293.15) annotation (Placement(transformation(extent={{50,-90},{30,-70}})));
