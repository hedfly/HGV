within GreenVillage.Buildings.Electrical.DC.Sources.Examples;
model WindTurbine "Example for the WindTurbine model"
  ...
  Buildings.Electrical.DC.Sources.WindTurbine tur(
    ...
    h=10,
    V_nominal=12) "Wind turbine" annotation (Placement(transformation(extent={{
            -10,-10},{10,10}}, origin={50,40})));
  ...
  Buildings.Electrical.DC.Loads.Resistor res(R=0.5, V_nominal=12) "Resistance"
