within GreenVillage.Buildings.Electrical.AC.ThreePhasesBalanced.Conversion.Examples;
model ACACTransformer
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.FixedVoltage sou(
    ...
    f=60,
    V=480) "Voltage source" annotation (Placement(transformation(extent={{-10,-10},
            {10,10}}, origin={-70,50})));
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.FixedVoltage sou1(
    definiteReference=true,
    f=60,
    V=480) "Voltage source for open and short circuit tests" annotation (
      Placement(transformation(extent={{-10,-10},{10,10}}, origin={-70,10})));
equation
