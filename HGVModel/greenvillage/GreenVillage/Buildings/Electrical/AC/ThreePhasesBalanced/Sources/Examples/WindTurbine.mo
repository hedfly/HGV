within GreenVillage.Buildings.Electrical.AC.ThreePhasesBalanced.Sources.Examples;
model WindTurbine "Example for the WindTurbine AC model"
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.WindTurbine tur(
    ...
    h=10,
    scale=10,
    V_nominal=480) "Wind turbine" annotation (Placement(transformation(extent={
            {-10,-10},{10,10}}, origin={60,0})));
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Loads.Resistive res(P_nominal=-500,
      V_nominal=480) "Resistive line"
