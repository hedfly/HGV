within GreenVillage.Buildings.Electrical.AC.ThreePhasesBalanced.Sensors.Examples;
model GeneralizedSensor "Example model for generalized sensor"
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Loads.Capacitive loa(V_nominal=
        480, P_nominal=-100) "Constant load"
    annotation (Placement(transformation(extent={{40,2},{60,22}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.FixedVoltage sou(f=60, V=
        480) "Voltage source"
