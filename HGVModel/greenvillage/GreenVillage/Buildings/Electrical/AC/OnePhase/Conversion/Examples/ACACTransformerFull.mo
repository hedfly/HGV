within GreenVillage.Buildings.Electrical.AC.OnePhase.Conversion.Examples;
model ACACTransformerFull
  ...
  Buildings.Electrical.AC.OnePhase.Sources.FixedVoltage sou(
    ...
    f=60,
    V=120) "Voltage source" annotation (Placement(transformation(extent={{-10,-10},
            {10,10}}, origin={-70,50})));
  ...
  Buildings.Electrical.AC.OnePhase.Sources.FixedVoltage sou1(
    definiteReference=true,
    f=60,
    V=120) "Voltage source for short circuit and open tests " annotation (
