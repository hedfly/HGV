within GreenVillage.Buildings.Electrical.AC.OnePhase.Sources.Examples;
model WindTurbine "Example for the WindTurbine AC model"
  ...
  Buildings.Electrical.AC.OnePhase.Sources.WindTurbine tur(
    ...
    h=10,
    scale=10,
    V_nominal=120) "Wind turbine" annotation (Placement(transformation(extent={
  ...
  Buildings.Electrical.AC.OnePhase.Loads.Resistive res(P_nominal=-500,
      V_nominal=120) "Resistive line"
