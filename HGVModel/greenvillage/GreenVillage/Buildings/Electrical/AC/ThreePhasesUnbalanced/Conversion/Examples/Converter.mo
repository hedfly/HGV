within GreenVillage.Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.Examples;
model Converter "Test for the AC/AC converter model"
  ...
  redeclare
      Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACConverter tra(
        conversionFactor=0.5, eta=0.9));
