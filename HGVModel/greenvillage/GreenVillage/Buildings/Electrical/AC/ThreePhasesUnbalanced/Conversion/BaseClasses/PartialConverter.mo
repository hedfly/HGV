within GreenVillage.Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses;
partial model PartialConverter "Partial model of a transformer"
  extends Buildings.Electrical.Icons.RefAngleConversion;
  replaceable Buildings.Electrical.Interfaces.PartialConversion conv1
    constrainedby Buildings.Electrical.Interfaces.PartialConversion(
  ...
  replaceable Buildings.Electrical.Interfaces.PartialConversion conv2
    constrainedby Buildings.Electrical.Interfaces.PartialConversion(
    redeclare package PhaseSystem_p =
        Buildings.Electrical.PhaseSystems.OnePhase,
    redeclare package PhaseSystem_n =
  ...
  replaceable Buildings.Electrical.Interfaces.PartialConversion conv3
    constrainedby Buildings.Electrical.Interfaces.PartialConversion(
    redeclare package PhaseSystem_p =
        Buildings.Electrical.PhaseSystems.OnePhase,
    redeclare package PhaseSystem_n =
