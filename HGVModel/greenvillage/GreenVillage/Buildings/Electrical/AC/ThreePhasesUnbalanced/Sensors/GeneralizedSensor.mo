within GreenVillage.Buildings.Electrical.AC.ThreePhasesUnbalanced.Sensors;
...
equation
  ...
  for i in 1:3 loop
    V[i] = Buildings.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal_n.phase[
      i].v);
    I[i] = Buildings.Electrical.PhaseSystems.OnePhase.systemCurrent(terminal_n.phase[
      i].i);
    S[i, :] = Buildings.Electrical.PhaseSystems.OnePhase.phasePowers_vi(v=
