within GreenVillage.Buildings.Electrical.AC.ThreePhasesUnbalanced.Loads.BaseClasses;
partial model BaseLoadCtrl
  ...
  parameter Buildings.Electrical.Types.Load mode(
    ...
    max=Buildings.Electrical.Types.Load.VariableZ_y_input)=Buildings.Electrical.Types.Load.FixedZ_steady_state "Parameters that specifies the mode of the load (e.g., steady state,
  ...
  replaceable Buildings.Electrical.Interfaces.Load load1(
    ...
    initMode=initMode) if plugPhase1 "Load 1"
  ...
  replaceable Buildings.Electrical.Interfaces.Load load2(
    ...
    mode=mode,
    V_nominal=V_nominal/sqrt(3),
    initMode=initMode) if plugPhase2 "Load 2"
  ...
  replaceable Buildings.Electrical.Interfaces.Load load3(
    ...
    mode=mode,
    V_nominal=V_nominal/sqrt(3),
    initMode=initMode) if plugPhase3 "Load 3"
  ...
  Modelica.Blocks.Interfaces.RealInput y1 if plugPhase1 and mode == Buildings.Electrical.Types.Load.VariableZ_y_input
    "Fraction of the nominal power consumed"                       annotation (Placement(transformation(
        ...
        rotation=180,
        origin={120,80})));
  Modelica.Blocks.Interfaces.RealInput Pow1(unit="W") if plugPhase1 and mode
     == Buildings.Electrical.Types.Load.VariableZ_P_input "Power consumed"
  ...
  Modelica.Blocks.Interfaces.RealInput y2 if plugPhase2 and mode == Buildings.Electrical.Types.Load.VariableZ_y_input
    "Fraction of the nominal power consumed"                       annotation (Placement(transformation(
        ...
        rotation=180,
        origin={120,0})));
  Modelica.Blocks.Interfaces.RealInput Pow2(unit="W") if plugPhase2 and mode
     == Buildings.Electrical.Types.Load.VariableZ_P_input "Power consumed"
                                           annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=180,
  ...
  Modelica.Blocks.Interfaces.RealInput y3 if plugPhase3 and mode == Buildings.Electrical.Types.Load.VariableZ_y_input
    "Fraction of the nominal power consumed"                       annotation (Placement(transformation(
        ...
        rotation=180,
        origin={120,-80})));
  Modelica.Blocks.Interfaces.RealInput Pow3(unit="W") if plugPhase3 and mode
     == Buildings.Electrical.Types.Load.VariableZ_P_input "Power consumed"
                                           annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=180,
