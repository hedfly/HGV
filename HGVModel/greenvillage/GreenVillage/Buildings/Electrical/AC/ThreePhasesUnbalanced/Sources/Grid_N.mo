within GreenVillage.Buildings.Electrical.AC.ThreePhasesUnbalanced.Sources;
model Grid_N "Electrical grid with neutral cable"
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Terminal4_p terminal
    "Connector for three-phase unbalanced systems" annotation (Placement(
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Sources.FixedVoltage_N sou(
    ...
    f=f,
    V=V,
    phiSou=phiSou) "Voltage source" annotation (Placement(transformation(extent=
           {{10,-10},{-10,10}}, origin={10,0})));
equation
  for i in 1:3 loop
