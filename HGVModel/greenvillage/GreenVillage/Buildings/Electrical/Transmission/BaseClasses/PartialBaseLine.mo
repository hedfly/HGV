within GreenVillage.Buildings.Electrical.Transmission.BaseClasses;
partial model PartialBaseLine "Partial cable line dispersion model"
  ...
  replaceable parameter
    Buildings.Electrical.Transmission.LowVoltageCables.Generic commercialCable
    constrainedby Buildings.Electrical.Transmission.BaseClasses.BaseCable
