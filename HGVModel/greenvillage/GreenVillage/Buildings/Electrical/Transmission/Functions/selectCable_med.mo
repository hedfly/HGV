within GreenVillage.Buildings.Electrical.Transmission.Functions;
...
algorithm
  ...
  assert(
    Transmission.Functions.selectVoltageLevel(V_nominal) == Buildings.Electrical.Types.VoltageLevel.Medium,
