within GreenVillage.Buildings.Utilities.Psychrometrics;
...
equation
  if approximateWetBulb then
    ...
    rh_per = 100*p/
      ...
      Xi[iWat]/(Xi[iWat] + Buildings.Utilities.Psychrometrics.Constants.k_mair*
      (1 - Xi[iWat]));
    ...
    XiSat = Buildings.Utilities.Psychrometrics.Functions.X_pSatpphi(
      ...
      p=p,
      phi=1);
    TWetBul = (TDryBul*((1 - Xi[iWat])*Buildings.Utilities.Psychrometrics.Constants.cpAir
       + Xi[iWat]*Buildings.Utilities.Psychrometrics.Constants.cpSte) + (Xi[
      iWat] - XiSat)*Buildings.Utilities.Psychrometrics.Constants.h_fg)/((1 -
      XiSat)*Buildings.Utilities.Psychrometrics.Constants.cpAir + XiSat*
