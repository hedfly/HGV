...
equation
  XWetBul = Buildings.Utilities.Psychrometrics.Functions.X_pSatpphi(
    pSat=Buildings.Utilities.Psychrometrics.Functions.saturationPressureLiquid(
      TWetBul),
    p=p,
    phi=1);
  TWetBul = (TDryBul*((1 - XDryBul)*Buildings.Utilities.Psychrometrics.Constants.cpAir
     + XDryBul*Buildings.Utilities.Psychrometrics.Constants.cpSte) + (XDryBul
     - XWetBul)*Buildings.Utilities.Psychrometrics.Constants.h_fg)/((1 -
    XWetBul)*Buildings.Utilities.Psychrometrics.Constants.cpAir + XWetBul*
