within GreenVillage.Buildings.Utilities.Psychrometrics.Functions;
function phi_pTX
...
algorithm
  phi := p/saturationPressure(T)*X_w/(X_w + Buildings.Utilities.Psychrometrics.Constants.k_mair
    *(1 - X_w));
  annotation (
    smoothOrder=1,
