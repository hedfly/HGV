within GreenVillage.Buildings.Utilities.Math.Functions.Examples;
model IsMonotonic
...
// Tests with weak monotonicity
    //strictly increasing
  assert(Buildings.Utilities.Math.Functions.isMonotonic(x_incStrict, strict=
  ...
  assert(false == Buildings.Utilities.Math.Functions.isMonotonic(x_notWeak,
    ...
    //strictly decreasing
  assert(Buildings.Utilities.Math.Functions.isMonotonic({2.5,2,0.1}, strict=
    false), "Error. Function should have returned true.");
     //weakly decreasing
  assert(Buildings.Utilities.Math.Functions.isMonotonic({3,1,1,0.5}, strict=
    false), "Error. Function should have returned true.");
...
// Tests with strict monotonicity
  ...
  assert(false == Buildings.Utilities.Math.Functions.isMonotonic(x_notWeak,
    ...
    //strictly decreasing
  assert(Buildings.Utilities.Math.Functions.isMonotonic(x_decStrict, strict=
    true), "Error. Function should have returned true.");
     //weakly decreasing
