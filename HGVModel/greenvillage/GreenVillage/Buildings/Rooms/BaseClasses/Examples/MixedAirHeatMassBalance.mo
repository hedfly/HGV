within GreenVillage.Buildings.Rooms.BaseClasses.Examples;
...
protected
  Buildings.Rooms.BaseClasses.MixedAirHeatGain heaGai(redeclare package Medium
      = Medium, final AFlo=5) "Model to convert internal heat gains"
