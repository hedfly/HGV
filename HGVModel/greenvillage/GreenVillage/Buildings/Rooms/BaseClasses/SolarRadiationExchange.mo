...
model SolarRadiationExchange
  ...
  extends Buildings.Rooms.BaseClasses.PartialSurfaceInterfaceRadiative(
    ...
    final epsConExtWinUns={(1 - datConExtWin[i].glaSys.glass[size(datConExtWin[
        i].glaSys.glass, 1)].tauSol - datConExtWin[i].glaSys.glass[size(
        datConExtWin[i].glaSys.glass, 1)].rhoSol_b) for i in 1:NConExtWin},
    final epsConExtWinSha={(1 - datConExtWin[i].glaSys.glass[size(datConExtWin[
        i].glaSys.glass, 1)].tauSol - datConExtWin[i].glaSys.glass[size(
        datConExtWin[i].glaSys.glass, 1)].rhoSol_b) for i in 1:NConExtWin},
