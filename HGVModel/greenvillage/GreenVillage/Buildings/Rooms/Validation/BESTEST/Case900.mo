...
model Case900 "Case 600, but with high thermal mass"
  ...
  Buildings.Rooms.Validation.BESTEST.Data.ExteriorWallCase900 extWalCase900
    "Exterior wall"
    annotation (Placement(transformation(extent={{32,50},{46,64}})));

  Buildings.Rooms.Validation.BESTEST.Data.FloorCase900 floorCase900 "Floor"
    annotation (Placement(transformation(extent={{60,50},{74,64}})));

  annotation (
experiment(StopTime=3.1536e+07),
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Rooms/Validation/BESTEST/Case900.mos"
