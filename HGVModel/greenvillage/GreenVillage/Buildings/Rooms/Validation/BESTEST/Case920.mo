...
model Case920 "Case 900, but with windows on East and West side walls"
  extends Buildings.Rooms.Validation.BESTEST.Case900(roo(
      nConExtWin=2,
      datConExtWin(
  ...
  annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Rooms/Validation/BESTEST/Case920.mos"
        "Simulate and plot"),
        experiment(
      StopTime=3.1536e+07,
      Interval=3600,
