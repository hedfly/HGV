...
model Case630 "Case 620, but with added overhang and sidefins"
  extends Buildings.Rooms.Validation.BESTEST.Case620(roo(datConExtWin(ove(
          each wR=0.0,
          each wL=0.0,
          each dep=1.0,
          each gap=0.5), sidFin(
  ...
  annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Rooms/Validation/BESTEST/Case630.mos"
        "Simulate and plot"),
        experiment(
      StopTime=3.1536e+07,
      Interval=3600,
