within GreenVillage.Buildings.Rooms.Validation.BESTEST;
model Case960 "Case 600, but with an unconditioned sun-space"
  ...
  Buildings.HeatTransfer.Conduction.MultiLayer parWal(layers=matLayPar, A=8*2.7)
    "Partition wall between the two rooms" annotation (Placement(transformation(
          extent={{-10,-10},{10,10}}, origin={120,-42})));

  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Brick120 matLayPar(material=
  ...
  parameter Buildings.Rooms.Validation.BESTEST.Data.ExteriorWallCase900 extWalCase900
    "Exterior wall"
    annotation (Placement(transformation(extent={{160,80},{174,94}})));

  parameter Buildings.Rooms.Validation.BESTEST.Data.FloorCase900 floorCase900 "Floor"
