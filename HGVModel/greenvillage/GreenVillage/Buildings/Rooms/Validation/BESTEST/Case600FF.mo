...
model Case600FF
  ...
  Buildings.Rooms.Validation.BESTEST.Data.Win600 window600(
    UFra=3,
  ...
  replaceable parameter
    Buildings.Rooms.Validation.BESTEST.Data.StandardResultsFreeFloating staRes(
    minT(
      Min=-18.8 + 273.15,
      Max=-15.6 + 273.15,
      Mean=-17.6 + 273.15),
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Rooms/Validation/BESTEST/Case600FF.mos"
