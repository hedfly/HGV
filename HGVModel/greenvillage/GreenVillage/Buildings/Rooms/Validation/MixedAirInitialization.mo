within GreenVillage.Buildings.Rooms.Validation;
model MixedAirInitialization
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic matLayRoo(material=
