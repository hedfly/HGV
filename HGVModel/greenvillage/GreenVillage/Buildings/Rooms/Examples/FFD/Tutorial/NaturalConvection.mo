within GreenVillage.Buildings.Rooms.Examples.FFD.Tutorial;
model NaturalConvection "Tutorial for Natural Convection case"
  extends Modelica.Icons.Example;
  package MediumA =
      Buildings.Media.Air (T_default=283.15) "Medium model";
  ...
  Buildings.Rooms.CFD roo(
    ...
    cfdFilNam=
        "modelica://Buildings/Resources/Data/Rooms/FFD/Tutorial/NaturalConvection.ffd",
    nConExt=nConExt,
