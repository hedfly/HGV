within GreenVillage.Buildings.Rooms.FLEXLAB.Rooms.Examples;
model TestBedX3WithRadiantFloor
  ...
  Buildings.Fluid.Sources.Boundary_pT airOutCloA(redeclare package Medium = Air,
      nPorts=1) "Air outlet from the closet in test cell X3A" annotation (
      Placement(transformation(extent={{-10,-10},{10,10}}, origin={-154,134})));
  ...
  Buildings.Fluid.Sources.Boundary_pT airOutCloB(redeclare package Medium = Air,
      nPorts=1) "Air outlet from the closet in test cell X3B" annotation (
      Placement(transformation(extent={{-10,-10},{10,10}}, origin={-18,134})));
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature preT
    "Temperature of the ground" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,-254})));
  ...
  parameter Buildings.Fluid.Data.Pipes.PEX_RADTEST pipe(dIn=0.015875, dOut=
        0.01905)
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature preT2 annotation (
      Placement(transformation(extent={{-10,-10},{10,10}}, origin={-240,-42})));
  ...
  Buildings.Fluid.Sources.Boundary_pT watOut4A2(nPorts=1, redeclare package
      Medium = Water) "Water outlet" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={-86,-174})));
  ...
  Buildings.Fluid.Sources.Boundary_pT watOut4B1(redeclare package Medium =
        Water, nPorts=1) "Water outlet" annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=180,
        origin={20,-210})));
