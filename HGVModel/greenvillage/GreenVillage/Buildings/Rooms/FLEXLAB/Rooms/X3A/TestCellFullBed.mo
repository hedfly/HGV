within GreenVillage.Buildings.Rooms.FLEXLAB.Rooms.X3A;
model TestCellFullBed
  ...
  extends Buildings.Rooms.MixedAir(
    ...
    surBou(
      ...
      each absIR=0.9,
      each absSol=0.9,
      til={Buildings.Types.Tilt.Floor,Buildings.Types.Tilt.Floor,Buildings.Types.Tilt.Floor,
          Buildings.Types.Tilt.Floor,Buildings.Types.Tilt.Wall}),
    datConExt(
      ...
      azi={Buildings.Types.Azimuth.N,Buildings.Types.Azimuth.N,Buildings.Types.Azimuth.S,
