within GreenVillage.Buildings.Obsolete.Media.GasesConstantDensity;
package MoistAirUnsaturated "Package with moist air model that decouples pressure and temperature and that has no liquid water"
  ...
  constant Buildings.Obsolete.Media.PerfectGases.Common.DataRecord dryair=Buildings.Obsolete.Media.PerfectGases.Common.SingleGasData.Air;
  constant Buildings.Obsolete.Media.PerfectGases.Common.DataRecord steam=Buildings.Obsolete.Media.PerfectGases.Common.SingleGasData.H2O;
...
algorithm
  h := (T - 273.15)*steam.cp +
    Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.enthalpyOfVaporization(
    T);
...
algorithm
  h :=
    Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.enthalpyOfCondensingGas(
    T)*X[Water] +
    Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.enthalpyOfDryAir(
    T)*(1.0 - X[Water]);
end enthalpyOfGas;
...
algorithm
  h := Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
    state.X);
...
redeclare function extends specificInternalEnergy "Specific internal energy"
  extends Modelica.Icons.Function;
algorithm
  u := Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
    state.X) - state.p/dStp;
...
redeclare function extends specificGibbsEnergy "Specific Gibbs energy"
  extends Modelica.Icons.Function;
algorithm
  g := Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
...
redeclare function extends specificHelmholtzEnergy "Specific Helmholtz energy"
  extends Modelica.Icons.Function;
algorithm
  f := Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
    state.X) - gasConstant(state)*state.T - state.T*
    Buildings.Obsolete.Media.GasesConstantDensity.MoistAirUnsaturated.specificEntropy(
    state);
