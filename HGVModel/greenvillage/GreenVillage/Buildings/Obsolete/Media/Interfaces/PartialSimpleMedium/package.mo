within GreenVillage.Buildings.Obsolete.Media.Interfaces;
partial package PartialSimpleMedium "Medium model with linear dependency of u, h from temperature. Most other quantities are constant."
