  ...
  package Examples
    ...
    package BasicStateGraphs
      ...
      model FirstExample_Variant2
        ...
        Modelica_StateGraph2.Step initialStep(nIn=2, nOut=1)
      ...
      model FirstExample_Variant3
        ...
        Modelica_StateGraph2.Step initialStep(
          ...
          nOut=1)
          annotation (Placement(transformation(extent={{-4,44},{4,52}})));
        Modelica_StateGraph2.Transition T1(use_conditionPort=false, condition=
             time > 2)
          annotation (Placement(transformation(extent={{-4,26},{4,34}})));
      ...
      model FirstExample_Variant4
        ...
        Modelica_StateGraph2.Step step3(
          ...
          nOut=1)
          annotation (Placement(transformation(extent={{4,-26},{-4,-18}})));
        Modelica_StateGraph2.Transition T3(delayedTransition=false, loopCheck=
             false)
          annotation (Placement(transformation(extent={{26,18},{34,10}})));
      ...
      model Composite1 "Example of a composite step"
        ...
        Modelica_StateGraph2.Transition T4(condition=time > 3.5 and time <=
              4.5)
      ...
      model ParallelWithSuspendAndNoResume
        ...
        Modelica_StateGraph2.Step step6(nOut=1, nIn=1)
      ...
      model ParallelInsideDelay
        ...
        Modelica_StateGraph2.Transition T2(waitTime=1, delayedTransition=true)
        ...
        Modelica_StateGraph2.Step step5(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-24,-32},{-16,-24}})));
      equation
        connect(step1.outPort[1],T1. inPort) annotation (Line(
            points={{0,65.4},{0,56}},
            color={0,0,0},
      ...
      model ParallelOutsideDelay
        ...
        Modelica_StateGraph2.Step step3(nOut=1, nIn=1)
          annotation (Placement(transformation(extent={{16,6},{24,14}})));
        Modelica_StateGraph2.Transition T2(delayedTransition=false)
          annotation (Placement(transformation(extent={{16,-14},{24,-6}})));
        Modelica_StateGraph2.Step step4(nOut=1, nIn=1)
          annotation (Placement(transformation(extent={{16,-34},{24,-26}})));
        Modelica_StateGraph2.Transition T3(waitTime=1, delayedTransition=true)
          annotation (Placement(transformation(extent={{56,-6},{64,-14}})));
        Modelica_StateGraph2.Transition T4(waitTime=1, delayedTransition=
              false)
          annotation (Placement(transformation(extent={{-24,-14},{-16,-6}})));
      ...
      model ParallelAutonomous "Demonstrates Parallel that runs autonomously"
        ...
        Modelica_StateGraph2.Step step1(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-24,-18},{-16,-10}})));
        Modelica_StateGraph2.Transition T3(waitTime=1, delayedTransition=true)
      ...
      model Actions1 "Demonstrates MultiSwitch and ShowValue"
        ...
        Modelica_StateGraph2.Transition T4(
          use_conditionPort=false,
          delayedTransition=true,
          waitTime=1) annotation (Placement(transformation(extent={{-64,-24},
                  {-56,-16}})));
        Modelica_StateGraph2.Transition T5(
          use_conditionPort=false,
          delayedTransition=true,
          waitTime=1) annotation (Placement(transformation(extent={{-64,-60},
                  {-56,-52}})));
      ...
      Modelica_StateGraph2.Blocks.MathReal.MultiSwitch multiSwitch1(nu=2,
            expr={2.2,4.4})
          annotation (Placement(transformation(extent={{16,62},{56,82}})));

      Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch multiSwitch2(nu=2,
            expr={2,4})
          annotation (Placement(transformation(extent={{-1,-46},{39,-26}})));

      Modelica_StateGraph2.Blocks.MathBoolean.MultiSwitch multiSwitch3(nu=2,
            expr={true,true})
      ...
      model Actions2 "Demonstrates rising and falling edge action blocks"
        ...
        Modelica_StateGraph2.Step step4(
          nIn=1,
          nOut=1,
          use_activePort=false) annotation (Placement(transformation(extent={
                  {-34,-42},{-26,-34}})));
        Modelica_StateGraph2.Transition T4(
          use_conditionPort=false,
          delayedTransition=true,
          waitTime=1) annotation (Placement(transformation(extent={{-34,-24},
                  {-26,-16}})));
        Modelica_StateGraph2.Transition T5(
          use_conditionPort=false,
          delayedTransition=true,
          waitTime=1) annotation (Placement(transformation(extent={{-34,-60},
                  {-26,-52}})));
        Modelica_StateGraph2.Step step1(
          nIn=1,
          nOut=1,
      ...
      model Actions3 "Demonstrates usage of TriggeredAdd action block"
        ...
        Modelica_StateGraph2.Transition T5(
          ...
          delayedTransition=true,
          waitTime=1,
          use_firePort=true) annotation (Placement(transformation(extent={{-34,
                  -60},{-26,-52}})));
        Modelica_StateGraph2.Step step1(
          nIn=1,
          nOut=1,
      ...
      Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch set1(nu=2, expr={11,
              12})
      ...
      Modelica_StateGraph2.Step step1(nOut=1, nIn=1)
      ...
      Modelica_StateGraph2.Step step3(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-44,-52},{-36,-44}})));
      Modelica_StateGraph2.Step step4(
          nOut=1,
          nIn=1,
          use_activePort=true)
          annotation (Placement(transformation(extent={{44,14},{36,22}})));
      Modelica_StateGraph2.Transition T3(delayedTransition=true, waitTime=2)
          annotation (Placement(transformation(extent={{36,-2},{44,6}})));
      Modelica_StateGraph2.Step step5(nOut=1, nIn=1)
          annotation (Placement(transformation(extent={{36,-20},{44,-12}})));
      Modelica_StateGraph2.Transition T4(delayedTransition=true, waitTime=4)
    ...
    package Applications
      ...
      package ControlledTanks
        ...
        Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource start(reset={
                stop.on,shut.on}, buttonTimeTable={20,280}) annotation (
              Placement(transformation(extent={{-100,20},{-80,40}}, rotation=
                    0)));
        Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource stop(reset={
              ...
              Placement(transformation(extent={{-100,-10},{-80,10}}, rotation=
                   0)));
        Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource shut(reset={
                start.on,stop.on}, buttonTimeTable={700}) annotation (
              Placement(transformation(extent={{-100,-40.5},{-80,-20.5}},
                  rotation=0)));
...
\"animationSpeed(speed = 50)\".
      ...
      model ControlledTanks2
        ...
        Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource stop(reset={
                start.on,shut.on}, buttonTimeTable={220,650}) annotation (
              Placement(transformation(extent={{-80,-10},{-60,10}}, rotation=
                    0)));
        Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource shut(reset={
                start.on,stop.on}, buttonTimeTable={700}) annotation (
              Placement(transformation(extent={{-80,-40},{-60,-20}}, rotation=
                   0)));
        protected
...
<li> The controller is hierarchically structured for the different tasks.</li>
      ...
      package Internal "Utility components for the examples"
        ...
        model TankController1
          ...
          Modelica_StateGraph2.Step startStep(nOut=1, nIn=2) annotation (
                Placement(transformation(extent={{37,96},{45,104}})));
          Modelica_StateGraph2.Transition T1(
              use_conditionPort=true,
              waitTime=0.01,
              delayedTransition=false) annotation (Placement(transformation(
                    extent={{37,84},{45,92}})));
          Modelica_StateGraph2.Step fillTank1(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{37,69},{45,77}})));
          Modelica_StateGraph2.Transition T2(condition=level1 > limit1)
              annotation (Placement(transformation(extent={{37,56},{45,64}})));
          Modelica_StateGraph2.Step wait1(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{37,40},{45,48}})));
          Modelica_StateGraph2.Step fillTank2(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{37,10},{45,18}})));
          Modelica_StateGraph2.Transition T3(delayedTransition=true, waitTime=
                 waitTime) annotation (Placement(transformation(extent={{37,
                      25},{45,33}})));
          Modelica_StateGraph2.Transition T4(condition=level1 < minLevel)
              annotation (Placement(transformation(extent={{37,-3},{45,5}})));
          Modelica_StateGraph2.Step wait2(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{37,-16},{45,-8}})));
          Modelica_StateGraph2.Transition T5(delayedTransition=true, waitTime=
                 waitTime) annotation (Placement(transformation(extent={{37,-30},
                      {45,-22}})));
          Modelica_StateGraph2.Step emptyTanks(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{37,-46},{45,-38}})));
          ...
          Modelica_StateGraph2.Transition T7 annotation (Placement(
                  transformation(extent={{44,137},{52,145}})));
          Modelica_StateGraph2.Step stopStep1(nIn=1, nOut=2) annotation (
                Placement(transformation(extent={{-33,53},{-25,61}})));
          ...
          Modelica_StateGraph2.Step shutTank1(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{-50,-14},{-42,-6}})));
          Modelica_StateGraph2.Transition T13(delayedTransition=false,
                condition=level1 < minLevel) annotation (Placement(
                  transformation(extent={{-50,-29},{-42,-21}})));
          Parallel shutStep(
            use_inPort=true,
            use_outPort=true,
            use_suspend=true,
          ...
          Modelica_StateGraph2.Step shutTank2(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{-23,-14},{-15,-6}})));
          ...
          Modelica_StateGraph2.Step shutWait(nOut=1, nIn=1) annotation (
                Placement(transformation(extent={{-34,27},{-26,35}})));
          Modelica_StateGraph2.Transition T17(delayedTransition=true,
                waitTime=0.01) annotation (Placement(transformation(extent={{
                      -34,14},{-26,22}})));
        ...
        model TankController2
          ...
          Modelica_StateGraph2.Step stopStep1(nIn=1, nOut=2) annotation (
                Placement(transformation(extent={{-23,4},{-15,12}})));
          Modelica_StateGraph2.Transition T8(use_conditionPort=false,
                condition=bus.stop) annotation (Placement(transformation(
                    extent={{-23,19},{-15,27}})));
          Modelica_StateGraph2.Transition T9(
              use_conditionPort=false,
              condition=bus.shut,
              delayedTransition=false,
              waitTime=0) annotation (Placement(transformation(extent={{-24,-9},
                      {-16,-1}})));
          ...
          Modelica_StateGraph2.Transition T14(
              delayedTransition=false,
              use_conditionPort=false,
              condition=bus.stop) annotation (Placement(transformation(extent=
                     {{-69,-35},{-61,-27}})));
          Modelica_StateGraph2.Step stopStep2(nIn=1, nOut=1) annotation (
          ...
          Modelica_StateGraph2.Transition T1(delayedTransition=true, waitTime=
                 0.01) annotation (Placement(transformation(extent={{-24,-35},
                      {-16,-27}})));
          Modelica_StateGraph2.Step waitStop(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{2,-25},{10,-17}})));
          Modelica_StateGraph2.Transition T2(delayedTransition=true, waitTime=
                 0.01) annotation (Placement(transformation(extent={{2,-37},{
                      10,-29}})));
          Modelica_StateGraph2.Step waitShut2(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{-69,-76},{-61,-68}})));
          Modelica_StateGraph2.Transition T3(delayedTransition=true, waitTime=
                 0.01) annotation (Placement(transformation(extent={{-69,-89},
                      {-61,-81}})));
        equation
        ...
        model MakeProduct
          ...
          SignalBus bus annotation (Placement(transformation(
                ...
                origin={200,0})));
          Modelica_StateGraph2.Step startStep(nOut=1, nIn=2) annotation (
                Placement(transformation(extent={{-24,72},{-16,80}})));
          Modelica_StateGraph2.Transition T1(
              waitTime=0.01,
              delayedTransition=false,
              use_conditionPort=false,
              condition=bus.start) annotation (Placement(transformation(
                    extent={{-24,60},{-16,68}})));
          ...
          Modelica_StateGraph2.Step wait1(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{-24,16},{-16,24}})));
          ...
          Modelica_StateGraph2.Blocks.MathBoolean.Or or1(nu=2) annotation (
                Placement(transformation(extent={{45,54},{57,66}})));
        equation
          connect(fillTank1.outPort[1], T2.inPort) annotation (Line(
        ...
        model ShutStep
          ...
          Modelica_StateGraph2.Step shutTank1(
              ...
              use_activePort=true) annotation (Placement(transformation(
                    extent={{-20,52},{-12,60}})));
          Modelica_StateGraph2.Transition T13(delayedTransition=false,
                condition=bus.level1 < minLevel) annotation (Placement(
                  transformation(extent={{-20,37},{-12,45}})));
          Modelica_StateGraph2.Step shutTank2(
              ...
              use_activePort=true) annotation (Placement(transformation(
                    extent={{16,52},{24,60}})));
          Modelica_StateGraph2.Step tank1Empty(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{-20,19},{-12,27}})));
          Modelica_StateGraph2.Step tank2Empty(nIn=1, nOut=1) annotation (
                Placement(transformation(extent={{16,19},{24,27}})));
          Modelica_StateGraph2.Transition T11(delayedTransition=false,
                condition=bus.level2 < minLevel) annotation (Placement(
                  transformation(extent={{16,37},{24,45}})));
          Modelica.Blocks.Interfaces.BooleanOutput valve2
              "Value of Boolean output"
                                      annotation (Placement(transformation(
                  extent={{100,70},{120,90}}), iconTransformation(extent={{200,
    ...
    package ProductionLine "Production line with simple robots"
      model MainSimple
        ...
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            table annotation (Placement(transformation(extent={{-40,34},{-20,
                    54}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            table1 annotation (Placement(transformation(extent={{-20,34},{0,
                    54}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
        ...
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.EndTable
            endTable annotation (Placement(transformation(extent={{40,34},{60,
                    54}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            table3 annotation (Placement(transformation(extent={{20,34},{40,
                    54}}, rotation=0)));
        ...
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotTermHorizontal
            robotTermHorizontal annotation (Placement(transformation(extent={
                    {-40,34},{-20,60}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotComTerm
            robotComTerm annotation (Placement(transformation(extent={{20,14},
                    {40,34}}, rotation=0)));
      ...
      model MainExtended
        ...
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.EndTable
            endTable annotation (Placement(transformation(extent={{60,-26},{
                    80,-6}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            table annotation (Placement(transformation(extent={{-60,54},{-40,
                    74}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            table2 annotation (Placement(transformation(extent={{-20,54},{0,
                    74}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TurnTableRight
            turnTableRight1 annotation (Placement(transformation(extent={{0,
                    54},{20,74}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableVertical
            tableDown annotation (Placement(transformation(extent={{0,34},{20,
                    54}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableVertical
            tableDown1 annotation (Placement(transformation(extent={{0,14},{
                    20,34}}, rotation=0)));
        ...
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TurnTableLeft
            turnTableLeft annotation (Placement(transformation(extent={{20,-26},
                    {40,-6}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            table1 annotation (Placement(transformation(extent={{40,-26},{60,
                    -6}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
        ...
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotTermHorizontal
            robotTermHorizontal annotation (Placement(transformation(extent={
                    {-60,54},{-40,80}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotTermVertical
            robotTermVertical annotation (Placement(transformation(extent={{0,
                    14},{26,34}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotVertical
            robotDown annotation (Placement(transformation(extent={{0,34},{26,
                    54}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
            robot1 annotation (Placement(transformation(extent={{40,-26},{60,
                    0}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
            tableHorizontal annotation (Placement(transformation(extent={{-40,
                    54},{-20,74}}, rotation=0)));
        Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
            robotHorizontal annotation (Placement(transformation(extent={{-40,
                    54},{-20,80}}, rotation=0)));
      equation
        connect(startTable.tableComNext, table.tableComPrev) annotation (Line(
      ...
      package Internal
        ...
        package Tables
          model StartTable
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
                tableComNext annotation (Placement(transformation(extent={{76,
                        -73},{84,-65}}, rotation=0), iconTransformation(
                      extent={{76,-74},{84,-66}})));
          ...
          model EndTable "Ends the line"
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
                tableComPrev annotation (Placement(transformation(extent={{-84,
                        -73},{-76,-65}}, rotation=0), iconTransformation(
                      extent={{-84,-74},{-76,-66}})));
          ...
          model TableVertical
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComTable
                robotComTable annotation (Placement(transformation(extent={{-96,
                        -6},{-84,6}}), iconTransformation(extent={{-74,16},{-66,
                        24}})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
                tableComNext annotation (Placement(transformation(extent={{-96,
                        -86},{-84,-74}}), iconTransformation(extent={{-74,-84},
                        {-66,-76}})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
                tableComPrev annotation (Placement(transformation(extent={{-96,
                        74},{-84,86}}), iconTransformation(extent={{-74,76},{
                        -66,84}})));
          ...
          model TurnTableRight
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
                tableComPrev annotation (Placement(transformation(extent={{-96,
                        -66},{-84,-54}}, rotation=0), iconTransformation(
                      extent={{-92,-74},{-84,-66}})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
                tableComNext annotation (Placement(transformation(extent={{-66,
                        -96},{-54,-84}}, rotation=0), iconTransformation(
                      extent={{-74,-92},{-66,-84}})));
            Modelica.Blocks.Sources.BooleanExpression Prev_Idle(y=Empty.active)
              annotation (Placement(transformation(
                  origin={-47,-54},
          ...
          model TableHorizontal
            ...
            Modelica_StateGraph2.Blocks.MathBoolean.ShowValue indicatorLamp
                annotation (Placement(transformation(
                    ...
                    origin={-72,50})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
                tableComPrev annotation (Placement(transformation(extent={{-86,
                        -96},{-74,-84}}), iconTransformation(extent={{-84,-74},
                        {-76,-66}})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComTable
                robotComTable annotation (Placement(transformation(extent={{-6,
                        -96},{6,-84}}), iconTransformation(extent={{-24,-74},
                        {-16,-66}})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
                tableComNext annotation (Placement(transformation(extent={{74,
                        -96},{86,-84}}), iconTransformation(extent={{76,-74},
                        {84,-66}})));
          equation
            carInPosition = pos >= -0.5 and pos < 0.5;
          ...
          model TurnTableLeft "Table which turns the track direction eastbound"
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
                tableComPrev annotation (Placement(transformation(extent={{-86,
                        86},{-74,74}}, rotation=0), iconTransformation(extent=
                       {{-82,82},{-74,74}})));
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
                tableComNext annotation (Placement(transformation(extent={{86,
                        -74},{74,-86}}, rotation=0), iconTransformation(
                      extent={{84,-66},{76,-74}})));
            Modelica.Blocks.Sources.BooleanExpression Prev_Idle(y=Empty.active)
              annotation (Placement(transformation(
                  origin={-19,94},
        ...
        package Utilities
          model RobotComTerm "Connects to table RobotCom, used for testing"
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
                robotComRobot annotation (Placement(transformation(extent={{
          ...
          model RobotHorizontal
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
                robotComRobot annotation (Placement(transformation(extent={{-4,
                        -84},{4,-76}}, rotation=0), iconTransformation(extent=
                       {{16,-74},{24,-66}})));
          ...
          model RobotVertical "Robot than can be connected with vertical table"
            extends
                Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Interfaces.Robot;
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
                robotComRobot annotation (Placement(transformation(extent={{-73,
                        -4},{-81,4}}, rotation=0), iconTransformation(extent=
                        {{-66,-24},{-74,-16}})));
          ...
          model RobotTermHorizontal
            ...
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
                robotComRobot annotation (Placement(transformation(extent={{-4,
                        -80},{4,-72}}, rotation=0), iconTransformation(extent=
                       {{16,-74},{24,-66}})));
          ...
          model RobotTermVertical
            ...
            extends
                Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Interfaces.RobotTerm;
            Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
                robotComRobot annotation (Placement(transformation(extent={{-81,
                        4},{-73,-4}}, rotation=0), iconTransformation(extent=
                        {{-74,-16},{-66,-24}})));
            Modelica.Blocks.Sources.BooleanExpression Start_Work(y=
                  robotComRobot.StartWork) annotation (Placement(transformation(
                  origin={9,0},
        ...
        package Interfaces
          partial model Table "Table Logic"
            ...
            Modelica_StateGraph2.Step InTransport(nIn=1, nOut=1) annotation (
                  Placement(transformation(extent={{56,44},{64,52}})));
            Modelica_StateGraph2.Transition limit_switch(use_conditionPort=
                    true, loopCheck=false) annotation (Placement(
                    transformation(extent={{56,30},{64,38}})));
            ...
            Modelica_StateGraph2.Step Empty(
                initialStep=true,
                nOut=2,
                nIn=2) annotation (Placement(transformation(extent={{36,76},{
                        44,84}})));
            Modelica_StateGraph2.Transition prev_receive(condition=false,
                  loopCheck=false) annotation (Placement(transformation(
                      extent={{-4,42},{4,50}})));
            Modelica_StateGraph2.Step Occupied(nIn=2, nOut=1) annotation (
                  Placement(transformation(extent={{36,10},{44,18}})));
            Modelica_StateGraph2.Transition robot_work_done(use_conditionPort=
                   true, loopCheck=false) annotation (Placement(
                    transformation(extent={{36,-4},{44,4}})));
          ...
          partial model TurnTable "Table which turns the track"
            ...
            Modelica_StateGraph2.Step InTransport(nIn=1, nOut=1) annotation (
                  Placement(transformation(extent={{56,38},{64,46}})));
            Modelica_StateGraph2.Transition limit_switch(use_conditionPort=
                    true, loopCheck=false) annotation (Placement(
                    transformation(extent={{56,18},{64,26}})));
            Modelica_StateGraph2.Transition prev_ready(use_conditionPort=true)
                annotation (Placement(transformation(extent={{56,58},{64,66}})));
            Modelica_StateGraph2.Step Empty(
                initialStep=true,
                nOut=2,
                nIn=2) annotation (Placement(transformation(extent={{36,78},{
                        44,86}})));
            Modelica_StateGraph2.Transition prev_receive(condition=false,
                  loopCheck=false) annotation (Placement(transformation(
                      extent={{-4,38},{4,46}})));
            Modelica_StateGraph2.Step Occupied(nIn=2, nOut=1) annotation (
                  Placement(transformation(extent={{36,-2},{44,6}})));
            Modelica_StateGraph2.Transition robot_work_done(use_conditionPort=
                   true, loopCheck=false) annotation (Placement(
                    transformation(extent={{36,-16},{44,-8}})));
            Modelica_StateGraph2.Step Waiting(nIn=1, nOut=2) annotation (
    ...
    package HarelsWristWatch
      ...
      model WristWatch
        ...
        Modelica_StateGraph2.Transition battery_removed(use_conditionPort=
        ...
        Modelica_StateGraph2.Blocks.Interactive.TrigButton insert_battery(label=
                "Insert Battery") annotation (Placement(transformation(extent=
                   {{0,220},{-80,240}})));
        Modelica_StateGraph2.Blocks.Interactive.TrigButton remove_battery(label=
                "Remove Battery") annotation (Placement(transformation(extent=
                   {{0,200},{-80,220}})));
        Modelica_StateGraph2.Blocks.Interactive.TrigButton kill_battery(label=
                "Kill Battery") annotation (Placement(transformation(extent={
                    {0,160},{-80,180}})));
        ...
        Modelica_StateGraph2.Transition alarm1_enabled_d(use_conditionPort=
                true, loopCheck=false) annotation (Placement(transformation(
                  extent={{76,-54},{84,-46}})));
        ...
        Modelica_StateGraph2.Transition thirty_secs_in_alarms_beep(
              delayedTransition=true, waitTime=30) annotation (Placement(
                transformation(extent={{-34,-104},{-26,-96}})));
        Modelica_StateGraph2.Blocks.Interactive.TrigButton weaken_battery(label=
                "Weaken Battery") annotation (Placement(transformation(extent=
                   {{0,180},{-80,200}})));
        ...
        Modelica_StateGraph2.Transition alarm2_disabled_d(use_conditionPort=
                true) annotation (Placement(transformation(extent={{76,-114},
                    {84,-106}})));
        Modelica_StateGraph2.Transition alarm2_enabled_d(use_conditionPort=
                true, loopCheck=false) annotation (Placement(transformation(
                  extent={{76,-154},{84,-146}})));
        ...
        Modelica_StateGraph2.Step light_on(
            ...
            use_activePort=true) annotation (Placement(transformation(extent=
                    {{236,-34},{244,-26}})));
        Modelica_StateGraph2.Transition light_off_b_down(use_conditionPort=
                true) annotation (Placement(transformation(extent={{236,-14},
                    {244,-6}})));
        Modelica_StateGraph2.Transition light_on_b_up(use_conditionPort=true,
              loopCheck=false) annotation (Placement(transformation(extent={{
                    236,-54},{244,-46}})));
        ...
        Modelica_StateGraph2.Transition chime_disabled_d(use_conditionPort=
                true, delayedTransition=false) annotation (Placement(
                transformation(extent={{174,-20},{166,-12}})));
        Modelica_StateGraph2.Transition chime_enabled_d(
            use_conditionPort=true,
            delayedTransition=false,
            loopCheck=false) annotation (Placement(transformation(extent={{
                    116,-24},{124,-32}})));
        Modelica_StateGraph2.Step power_ok(nOut=1, nIn=1) annotation (
              Placement(transformation(extent={{246,-94},{254,-86}})));
        ...
        inner
            ...
            signalBus annotation (Placement(transformation(extent={{-132,198},
                    {-92,238}})));
        public
        Modelica_StateGraph2.Transition battery_inserted(use_conditionPort=
                true, loopCheck=false)
            annotation (Placement(transformation(extent={{-4,76},{4,84}})));
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            displays_bus_node annotation (Placement(transformation(extent={{-100,
                    -80},{-80,-60}})));
        public
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            top_level_bus_node annotation (Placement(transformation(extent={{
                    -122,80},{-102,100}})));
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            main_bus_node annotation (Placement(transformation(extent={{200,-10},
                    {220,10}})));
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            alarms_bus_node annotation (Placement(transformation(extent={{50,
                    -200},{70,-180}})));
        public
        ...
        Modelica_StateGraph2.Transition wait_c_up_1(
            delayedTransition=true,
            use_conditionPort=true,
            waitTime=0.01) annotation (Placement(transformation(extent={{-244,
                    -24},{-236,-32}})));
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            top_level_bus_node1 annotation (Placement(transformation(extent={
                    {-190,140},{-170,160}}), iconTransformation(extent={{-82,
                    110},{-62,130}})));
        public
        Modelica_StateGraph2.Blocks.MathBoolean.Or or1(nu=2) annotation (
              Placement(transformation(
...
<p>To run model interactively, enable Realtime in the Experiment setup and set load result interval to 0.01.</p>
      ...
      model Regular
        ...
        Modelica_StateGraph2.Step hour(
            nOut=1,
            use_activePort=true,
            nIn=1) annotation (Placement(transformation(extent={{-84,46},{-76,
                    54}})));
        ...
        Modelica_StateGraph2.Step day(
            nOut=1,
            use_activePort=true,
            nIn=1) annotation (Placement(transformation(extent={{-44,46},{-36,
                    54}})));
        ...
        Modelica_StateGraph2.Transition perform_increment(
            use_firePort=true,
            use_conditionPort=true,
            loopCheck=false) annotation (Placement(transformation(extent={{-154,
                    -6},{-146,2}})));
        ...
        Modelica_StateGraph2.Step OO(nOut=2, nIn=3) annotation (Placement(
                transformation(extent={{120,34},{128,42}})));
        ...
        Modelica_StateGraph2.Step beep(nOut=2, nIn=2) annotation (Placement(
                transformation(extent={{120,-46},{128,-38}})));
        ...
        Modelica_StateGraph2.Transition two_min_in_date(delayedTransition=
                true, waitTime=120)
        ...
        outer
            Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            signalBus annotation (Placement(transformation(extent={{120,-100},
                    {160,-60}})));
        public
        Modelica.Blocks.Logical.And and1
        ...
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            bus_node2 annotation (Placement(transformation(extent={{-160,-100},
                    {-140,-80}})));
        public
        ...
        Modelica.Blocks.Logical.Edge pre1 annotation (Placement(transformation(
              ...
              rotation=90,
              origin={-130,-86})));
        Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd time_setting(use_reset=
               true) annotation (Placement(transformation(extent={{48,-76},{
                    60,-64}})));
        ...
        Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch date_quantity(
            ...
            expr={100,1}) annotation (Placement(transformation(
                ...
                rotation=0,
                origin={20,-50})));
        Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd date_setting(use_reset=
               true) annotation (Placement(transformation(extent={{48,-56},{
                    60,-44}})));
        Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch mode_quantity(
            ...
            expr={1}) annotation (Placement(transformation(
                ...
                rotation=0,
                origin={20,-30})));
        Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd mode_setting(use_reset=
               true) annotation (Placement(transformation(extent={{48,-36},{
                    60,-24}})));
        Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch year_quantity(
            ...
            expr={1}) annotation (Placement(transformation(
                ...
                rotation=0,
                origin={20,-10})));
        Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd year_setting(use_reset=
               true)
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            bus_node3 annotation (Placement(transformation(extent={{64,-30},{
                    84,-10}})));
        public
      ...
      model Out
        ...
        Modelica_StateGraph2.Transition chime_off_d(use_conditionPort=true,
              use_firePort=false) annotation (Placement(transformation(extent=
                   {{-204,16},{-196,24}})));
        ...
        Modelica_StateGraph2.Transition chime_on_d(
            use_conditionPort=true,
            use_firePort=false,
            loopCheck=false) annotation (Placement(transformation(extent={{-204,
                    -24},{-196,-16}})));
        Parallel alarm1(
          nEntry=1,
          use_suspend=true,
        ...
        Modelica_StateGraph2.Transition alarm1_on_d(
            use_conditionPort=true,
            use_firePort=false,
            loopCheck=false) annotation (Placement(transformation(extent={{76,
                    -24},{84,-16}})));
        Parallel update1(
          use_outPort=true,
          use_suspend=true,
        ...
        Modelica_StateGraph2.Transition update1_ten_min_c(use_conditionPort=
                true) annotation (Placement(transformation(extent={{166,-14},
                    {174,-6}})));
        Modelica_StateGraph2.Step update1_min(
            nIn=1,
            use_activePort=true,
            nOut=1) annotation (Placement(transformation(extent={{166,-34},{
                    174,-26}})));
        ...
        Modelica_StateGraph2.Transition alarm2_on_d(
            use_conditionPort=true,
            use_firePort=false,
            loopCheck=false) annotation (Placement(transformation(extent={{-112,
                    -24},{-104,-16}})));
        Parallel update2(
          use_outPort=true,
          use_suspend=true,
        ...
        Modelica_StateGraph2.Transition update2_ten_min_c(use_conditionPort=
                true) annotation (Placement(transformation(extent={{-24,-14},
                    {-16,-6}})));
        ...
        Modelica_StateGraph2.Transition update2_d(
            use_firePort=true,
            use_conditionPort=true,
            loopCheck=false) annotation (Placement(transformation(extent={{-52,
                    10},{-44,18}})));
        ...
        outer
            Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            signalBus annotation (Placement(transformation(extent={{-240,60},
                    {-200,100}})));
        public
        Modelica.Blocks.Logical.Edge edge2
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            update2_bus_node annotation (Placement(transformation(extent={{-2,
                    -44},{18,-24}}), iconTransformation(extent={{-10,-4},{10,
                    16}})));
        public
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            alarm2_bus_node annotation (Placement(transformation(extent={{-88,
                    -10},{-68,10}})));
        public
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            chime_bus_node annotation (Placement(transformation(extent={{-180,
                    -10},{-160,10}})));
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            alarm1_bus_node annotation (Placement(transformation(extent={{100,
                    -10},{120,10}})));
        public
        ...
        protected
        Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            alarm1_bus_node1 annotation (Placement(transformation(extent={{
                    190,-44},{210,-24}}), iconTransformation(extent={{190,-20},
                    {210,0}})));
        public
        Modelica.Blocks.Logical.Edge edge1 annotation (Placement(transformation(
              extent={{-4,-4},{4,4}},
      ...
      model Stopwatch
        ...
        Modelica_StateGraph2.Step off(nIn=1, nOut=2) annotation (Placement(
                transformation(extent={{26,-44},{34,-36}})));
        ...
        Modelica_StateGraph2.Transition lap_d(
            use_conditionPort=true,
            delayedTransition=false,
            loopCheck=false) annotation (Placement(transformation(extent={{-14,
                    -16},{-6,-24}})));
        ...
        Modelica_StateGraph2.Transition off_b(
            use_conditionPort=true,
            delayedTransition=false,
            loopCheck=false) annotation (Placement(transformation(extent={{46,
                    -16},{54,-24}})));
        ...
        outer
            Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
            signalBus annotation (Placement(transformation(extent={{-100,60},
                    {-60,100}})));
        public
        Modelica.Blocks.Logical.Edge edge1
        ...
        Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd stopwatch_clock(use_reset=
               true)
...
<li>Illumination level at the top. Range 0-2. Signals are decoded as: 0 - dark, 1 - normal, 2 - bright.</li>
        ...
        model Time
          ...
          Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd clock(use_reset=
                 true, use_set=true) annotation (Placement(transformation(
                    extent={{-40,74},{-28,86}})));
        ...
        block DisplayDecoder
          ...
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch digit1_decoder(
              ...
              expr={div(mod(div(time_signal, 3600), 12), 10),div(mod(div(
                  time_signal, 3600), 24), 10),div(mod(div(date_signal, 100),
                  12), 10),div(mod(year_signal, 10000), 1000),div(mod(div(div(
                  stopwatch_signal, 100), 60), 60), 10)}) annotation (
                Placement(transformation(extent={{50,70},{90,90}})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch digit2_decoder(
              use_pre_as_default=false,
              nu=5,
              expr={mod(mod(div(time_signal, 3600), 12), 10),mod(mod(div(
                  time_signal, 3600), 24), 10),mod(mod(div(date_signal, 100),
                  12), 10),div(mod(year_signal, 1000), 100),mod(mod(div(div(
                  stopwatch_signal, 100), 60), 60), 10)}) annotation (
                Placement(transformation(extent={{50,40},{90,60}})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch digit3_decoder(
              use_pre_as_default=false,
              nu=5,
              expr={div(mod(div(time_signal, 60), 60), 10),div(mod(div(
                  time_signal, 60), 60), 10),div(mod(mod(date_signal, 100),
                  30), 10),div(mod(year_signal, 100), 10),div(mod(div(
                  stopwatch_signal, 100), 60), 10)}) annotation (Placement(
                  transformation(extent={{50,10},{90,30}})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch digit4_decoder(
              use_pre_as_default=false,
              nu=5,
              expr={mod(mod(div(time_signal, 60), 10), 10),mod(mod(div(
                  time_signal, 60), 10), 10),mod(mod(mod(date_signal, 100),
                  30), 10),mod(year_signal, 10),mod(mod(div(stopwatch_signal,
                  100), 60), 10)}) annotation (Placement(transformation(
                    extent={{50,-20},{90,0}})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch text_digit_decoder(
              use_pre_as_default=false,
              nu=5,
              expr={if mod(div(time_signal, 3600), 24) < 12 then 8 else 9,-1,
                  day_signal,-1,11}) annotation (Placement(transformation(
                    extent={{50,-80},{90,-60}})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch small_digit_decoder(
              use_pre_as_default=false,
              nu=5,
              expr={12,24,-1,-1,mod(stopwatch_signal, 100)}) annotation (
                Placement(transformation(extent={{50,-50},{90,-30}})));
...
<p>Decodes a number of integer signals (input at the bottom) into six digits to be displayed on a LED display according to definition in the WatchDisplay. Depending on the selected mode, the signals are masked in order to show the chosen entity correctly.</p>
        ...
        block AlarmTrigger
          ...
          Modelica_StateGraph2.Blocks.MathBoolean.Or or1(nu=2) annotation (
                Placement(transformation(extent={{-20,50},{0,70}})));
          Modelica_StateGraph2.Blocks.MathBoolean.And and1(nu=3) annotation (
                Placement(transformation(extent={{24,70},{44,90}})));
          Modelica_StateGraph2.Blocks.MathBoolean.And and3(nu=4) annotation (
          ...
          Modelica_StateGraph2.Blocks.MathBoolean.Or or2(nu=1) annotation (
                Placement(transformation(extent={{10,10},{30,30}})));
          Modelica_StateGraph2.Blocks.MathBoolean.And and2(nu=3) annotation (
                Placement(transformation(extent={{46,30},{66,50}})));
          ...
          Modelica_StateGraph2.Blocks.MathBoolean.Or or3(nu=3) annotation (
...
<p>Both alarms will beep when time becomes equal to T1 and P is true.</p>
        ...
        model WatchController
          import HGV.Modelica_StateGraph2;
...
<p>The watch controller contains the clock functionality, gathering of stopwatch signals, time settings and modes from different parts of the wristwatch that are gathered, grouped together and finally decoded into outputs to the LED display.</p>
    ...
    model Deadlock
      ...
      Modelica_StateGraph2.Transition release3(
          use_conditionPort=true,
          delayedTransition=false,
          loopCheck=false) annotation (Placement(transformation(extent={{-24,
                  -84},{-16,-76}})));
      ...
      Modelica_StateGraph2.Transition ready1(
          delayedTransition=true,
          use_firePort=false,
          waitTime=1) annotation (Placement(transformation(extent={{-80,-80},
                  {-72,-72}})));
      ...
      Modelica_StateGraph2.Transition start2(delayedTransition=true, waitTime=
             2)
  ...
  package WrongStateGraphs
    ...
    model SimpleInfiniteLoop
      ...
      Modelica_StateGraph2.Step step2(nIn=1, nOut=1)
          annotation (Placement(transformation(extent={{-24,-4},{-16,4}})));
      Modelica_StateGraph2.Transition T2 annotation (Placement(transformation(
                extent={{-24,-20},{-16,-12}})));
      Modelica_StateGraph2.Step step3(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-24,-38},{-16,-30}})));
    ...
    model SeveralInfiniteLoops
      ...
      Modelica_StateGraph2.Step step3(nIn=1, nOut=3) annotation (Placement(
              transformation(extent={{-44,-40},{-36,-32}})));
      Modelica_StateGraph2.Transition T3(delayedTransition=true, waitTime=1)
          annotation (Placement(transformation(extent={{-14,2},{-6,-6}})));
      Modelica_StateGraph2.Transition T4(waitTime=1.5, delayedTransition=
              false)
          annotation (Placement(transformation(extent={{12,2},{20,-6}})));
      Modelica_StateGraph2.Transition T5(waitTime=1.7, delayedTransition=
              false)
    ...
    model ParallelWithInfiniteLoop
      ...
      Modelica_StateGraph2.Step step1(
          ...
          initialStep=true,
          nIn=1)
          annotation (Placement(transformation(extent={{-4,68},{4,76}})));
      Parallel parallel(
        use_inPort=true,
        use_outPort=true,
        nIn=1,
    ...
    model TwoInitialSteps
      ...
      Modelica_StateGraph2.Step step3(
          nIn=1,
          nOut=1,
          initialStep=true) annotation (Placement(transformation(extent={{-24,
                  -38},{-16,-30}})));
      Modelica_StateGraph2.Transition T3(delayedTransition=true, waitTime=1)
          annotation (Placement(transformation(extent={{16,4},{24,-4}})));
    equation
    ...
    model UnsafeParallel2
      ...
      Modelica_StateGraph2.Step step1(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-24,-24},{-16,-16}})));
      Modelica_StateGraph2.Step step5(
          nIn=1,
          nOut=1,
          initialStep=true)
    ...
    model UnsafeParallel4
      ...
      Modelica_StateGraph2.Step step1(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-34,-24},{-26,-16}})));
      Modelica_StateGraph2.Step step5(
          nIn=1,
          nOut=1,
          initialStep=true)
    ...
    model NoUnaryConnection1
      ...
      Modelica_StateGraph2.Transition T1
          annotation (Placement(transformation(extent={{-4,10},{4,18}})));
      Modelica_StateGraph2.Step step1(nIn=1, nOut=1) annotation (Placement(
              transformation(extent={{-24,-20},{-16,-12}})));
      Modelica_StateGraph2.Step step2(nIn=1, nOut=1)
      ...
      Modelica_StateGraph2.Transition T3 annotation (Placement(transformation(
                extent={{-24,-38},{-16,-30}})));
    equation
      connect(T1.outPort, step1.inPort[1]) annotation (Line(
...
model Parallel "Composite or parallel step"
  ...
  Modelica_StateGraph2.Internal.Interfaces.Composite_suspend suspend[nSuspend] if
         use_suspend
      "If enabled, port for zero, one or more suspend transitions"
  ...
  Modelica_StateGraph2.Internal.Interfaces.Composite_resume resume[nResume] if
         use_suspend
      "If enabled, port for zero, one or more resume transitions" annotation (
       Placement(iconTransformation(extent={{-63,-31},{-57,-59}})));
  ...
  Modelica_StateGraph2.Internal.Interfaces.ExitPort exit[nExit] if
      use_outPort
...
partial model PartialParallel
  ...
  Modelica_StateGraph2.Internal.Interfaces.Composite_resume resume[nResume] if
         use_suspend
      "If enabled, port for zero, one or more resume transitions" annotation (
       Placement(iconTransformation(extent={{-208,-160},{-193,-80}})));
  Modelica_StateGraph2.Internal.Interfaces.Composite_suspend suspend[nSuspend] if
         use_suspend
      "If enabled, port for zero, one or more suspend transitions"
...
time instant. At all other time instants, y = <b>false</b>.
    ...
    block MultiSwitch
      ...
      Modelica_StateGraph2.Blocks.Interfaces.BooleanVectorInput u[nu]
          "Set y = expr[i], if u[i] = true" annotation (Placement(
              transformation(extent={{-110,30},{-90,-30}})));
      ...
      if initialStep then
        ...
        suspend_fire = Modelica_StateGraph2.Blocks.BooleanFunctions.anyTrue(
          ...
          Modelica_StateGraph2.Blocks.BooleanFunctions.anyTrue(local_resume.node.suspend)
           or Modelica_StateGraph2.Blocks.BooleanFunctions.anyTrue(
          local_suspend.fire);
