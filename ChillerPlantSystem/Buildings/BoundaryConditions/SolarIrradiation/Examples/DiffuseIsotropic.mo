within ChillerPlantSystem.Buildings.BoundaryConditions.SolarIrradiation.Examples;
model DiffuseIsotropic
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus annotation (Placement(
        transformation(extent={{1,-1},{21,21}}), iconTransformation(extent={{1,
            -1},{2,-2}})));
  Buildings.BoundaryConditions.SolarIrradiation.DiffuseIsotropic HDifRoo(til=
        Buildings.HeatTransfer.Types.Tilt.Ceiling, rho=rho)
    "Diffuse irradiation on roof"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  Buildings.BoundaryConditions.SolarIrradiation.DiffuseIsotropic HDifFlo(til=
        Buildings.HeatTransfer.Types.Tilt.Floor, rho=rho)
    "Diffuse irradiation on floor"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));
  Buildings.BoundaryConditions.SolarIrradiation.DiffuseIsotropic HDifWal(til=
        Buildings.HeatTransfer.Types.Tilt.Wall, rho=rho)
