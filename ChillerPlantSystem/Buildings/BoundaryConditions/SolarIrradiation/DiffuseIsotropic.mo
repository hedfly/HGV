within ChillerPlantSystem.Buildings.BoundaryConditions.SolarIrradiation;
...
protected
  Buildings.BoundaryConditions.SolarIrradiation.BaseClasses.DiffuseIsotropic HDifTilIso(til=til,
      rho=rho) annotation (Placement(transformation(extent={{-20,-10},{0,10}})));
