within ChillerPlantSystem.Buildings.BoundaryConditions.SolarIrradiation.BaseClasses;
block BrighteningCoefficient "Circumsolar and horizon brightening coefficients"
  extends Modelica.Blocks.Interfaces.BlockIcon;
  import H =
    ChillerPlantSystem.Buildings.Utilities.Math.Functions.spliceFunction;
public
