...
model ConductorSingleLayerPCM "Test model for heat conductor"
  ...
  parameter Buildings.HeatTransfer.Data.Solids.Concrete concrete100(x=0.1,
      nStaRef=4) "Non-PCM material"
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer conPCM(A=1, material=matPCM)
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer conPCM2(A=1, material=matPCM2)
