...
model ConductorSingleLayer "Test model for heat conductor"
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con1(A=1, material=concrete100)
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con2(A=1, material=concrete100)
  ...
  parameter Buildings.HeatTransfer.Data.Solids.Concrete concrete200(x=0.2, nSta=
       4) annotation (Placement(transformation(extent={{20,60},{40,80}})));
  parameter Buildings.HeatTransfer.Data.Solids.Concrete concrete100(x=0.1, nSta=
       2) annotation (Placement(transformation(extent={{60,60},{80,80}})));
