...
model ConductorSteadyStateTransient "Test model for heat conductor"
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con(A=2, material=brick)
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con1(A=2, material=insul)
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con2(A=2, material=brick)
