within ChillerPlantSystem.Buildings.HeatTransfer.Conduction.BaseClasses.Examples;
model Temperature_u
  ...
  parameter Real[Buildings.HeatTransfer.Conduction.nSupPCM] dT_duMonotone(each
      fixed=false, each unit="kg.K2/J")
