within ChillerPlantSystem.Buildings.HeatTransfer.Convection.Examples;
model Exterior "Test model for exterior heat transfer coefficients"
  ...
  Buildings.HeatTransfer.Convection.Exterior nor(
    ...
    "North-facing wall" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={30,30})));
  Buildings.HeatTransfer.Convection.Exterior wes(
    ...
    til=Buildings.HeatTransfer.Types.Tilt.Wall,
    conMod=Buildings.HeatTransfer.Types.ExteriorConvection.TemperatureWind)
    "West facing wall" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-10,0})));
  ...
  Buildings.HeatTransfer.Convection.Exterior sou(
    ...
    til=Buildings.HeatTransfer.Types.Tilt.Wall,
    conMod=Buildings.HeatTransfer.Types.ExteriorConvection.TemperatureWind)
    "South facing wall" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={30,-30})));
  Buildings.HeatTransfer.Convection.Exterior eas(
    ...
    til=Buildings.HeatTransfer.Types.Tilt.Wall,
    conMod=Buildings.HeatTransfer.Types.ExteriorConvection.TemperatureWind)
    "East facing wall" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={70,-14})));
