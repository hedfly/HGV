...
model Window "Test model for the window"
  ...
  Buildings.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil(
    til=til,
    lat=lat,
    azi=azi) annotation (Placement(transformation(extent={{60,-20},{80,0}})));
...
public
  Buildings.HeatTransfer.Windows.BaseClasses.ShadeRadiation intShaRad(
    ...
    A=AGla) if glaSys.haveShade "Interior shade radiation model"
...
public
  Buildings.HeatTransfer.Windows.BaseClasses.ShadingSignal shaSig(haveShade=
        glaSys.haveInteriorShade) "Conversion for shading signal"
