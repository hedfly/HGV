within ChillerPlantSystem.Buildings.HeatTransfer.Windows.Examples;
model BoundaryHeatTransfer
  ...
  parameter
    Buildings.HeatTransfer.Data.GlazingSystems.TripleClearAir13ClearAir13Clear glaSys3(UFra=1)
 ...
 Buildings.HeatTransfer.Radiosity.IndoorRadiosity radIn(final linearize=
        linearizeRadiation, final A=A) "Indoor radiosity"
...
public
  Buildings.HeatTransfer.Windows.BaseClasses.ShadingSignal shaSig(haveShade=
        true) "Conversion for shading signal"
