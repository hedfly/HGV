within ChillerPlantSystem.Buildings.HeatTransfer.Windows.BaseClasses.Examples;
model GasConvection "Test problem for convection in the gas layer"
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature T_b1(T=293.15)
    "Room-side temperature" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={50,30})));
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.GasConvection conCei(
    ...
    "Model for gas convection in horizontal gap in a ceiling" annotation (
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.GasConvection conFlo(
    ...
    "Model for gas convection in horizontal gap in a floor" annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={10,-110})));
