within ChillerPlantSystem.Buildings.Examples.VAVCO2.BaseClasses;
...
scaM_flow*(5.196+2.8428+1.0044+0.9612+0.3624+0.1584);
  Buildings.Fluid.FixedResistances.SplitterFixedResistanceDpM spl34(
    ...
    dp_nominal={0.176,-0.844,-0.0662}) annotation (extent=[-30,110; -10,130],
      Placement(transformation(extent={{-30,110},{-10,130}})));
  Buildings.Fluid.FixedResistances.SplitterFixedResistanceDpM mix55(
    redeclare package Medium = Medium,
    m_flow_nominal=scaM_flow*{-1,1,1},
    dp_nominal=1E3*{-0.263200E-02,0.999990E-03,0.649000E-03}) annotation (
  ...
  Buildings.Fluid.FixedResistances.SplitterFixedResistanceDpM mix52(
    redeclare package Medium = Medium,
    m_flow_nominal=scaM_flow*{-1,1,1},
    dp_nominal=1E3*{-0.353960,0.494000E-03,0.922000E-03}) annotation (extent=[
        150,-30; 170,-50], Placement(transformation(extent={{150,-30},{170,-50}})));
  ...
  Buildings.Fluid.Sensors.Pressure pRoo(redeclare package Medium = Medium)
    "Room pressure" annotation (extent=[234,140; 254,160], Placement(
        transformation(extent={{234,140},{254,160}})));
