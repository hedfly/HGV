within ChillerPlantSystem.Buildings.Examples.Tutorial.Boiler;
model System6
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temRoo
    "Room temperature" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-40,30})));
  Buildings.Fluid.Movers.FlowMachine_m_flow pumRad(m_flow_nominal=
        mRad_flow_nominal, redeclare package Medium = MediumW)
  ...
  Buildings.Fluid.FixedResistances.SplitterFixedResistanceDpM spl2(
    ...
    m_flow_nominal={mRad_flow_nominal,-mRadVal_flow_nominal,-mRad_flow_nominal
        ...
        rotation=270,
        origin={60,-110})));
  Buildings.Fluid.FixedResistances.SplitterFixedResistanceDpM mix2(
    redeclare package Medium = MediumW,
    m_flow_nominal={mRadVal_flow_nominal,-mBoi_flow_nominal,mBoi_flow_nominal},
    dp_nominal={0,-200,0}) "Mixer" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={60,-190})));
  ...
  Buildings.Fluid.FixedResistances.SplitterFixedResistanceDpM spl4(
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={60,-150})));
  Buildings.Fluid.Movers.FlowMachine_m_flow pumBoi(redeclare package Medium =
        MediumW, m_flow_nominal=mBoi_flow_nominal) "Pump for boiler"
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-50,-280})));
  ...
  Buildings.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valRad(
    ...
    l={0.01,0.01},
    dpValve_nominal=6000) "Three-way valve" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-50,-150})));
  Buildings.Fluid.Sources.FixedBoundary preSou(redeclare package Medium =
        MediumW, nPorts=1)
  ...
  Buildings.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valBoi(
    ...
    m_flow_nominal=mBoi_flow_nominal,
    l={0.01,0.01},
    dpValve_nominal=6000) "Three-way valve for boiler" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={60,-250})));
