within ChillerPlantSystem.Buildings.Examples.ChillerPlant.BaseClasses;
model SimplifiedRoom "Simplified data center room"
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume rooVol(
    ...
    m_flow_nominal=m_flow_nominal) "Volume of air in the room" annotation (
      Placement(transformation(extent={{41,-20},{61,-40}}, rotation=0)));
