within ChillerPlantSystem.Buildings.Utilities.Psychrometrics.Functions.BaseClasses.Examples;
...
initial equation
  y = x;
equation
  x = Buildings.Utilities.Psychrometrics.Functions.TDewPoi_pW_amb(p_w=time*
    uniCon);
  der(y) = der(x);
