within ChillerPlantSystem.Buildings.Utilities.Psychrometrics;
...
protected
 ...
 parameter Integer iWat(fixed=false)
  ...
  constant Modelica.SIunits.SpecificHeatCapacity cpAir=Buildings.Media.PerfectGases.Common.SingleGasData.Air.cp
    "Specific heat capacity of air";
  constant Modelica.SIunits.SpecificHeatCapacity cpSte=Buildings.Media.PerfectGases.Common.SingleGasData.H2O.cp
