within ChillerPlantSystem.Buildings.Rooms;
model MixedAir "Model of a room in which the air is completely mixed"
  ...
  Buildings.Rooms.BaseClasses.SolarRadiationExchange solRadExc(
    ...
    final tauGla={datConExtWin[i].glaSys.glass[datConExtWin[i].glaSys.nLay].tauSol
...
protected
  ...
  Buildings.Rooms.BaseClasses.HeatGain heaGai(redeclare package Medium = Medium,
      final AFlo=AFlo) "Model to convert internal heat gains"
