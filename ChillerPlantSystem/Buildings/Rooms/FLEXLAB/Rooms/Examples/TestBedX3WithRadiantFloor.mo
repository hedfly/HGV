within ChillerPlantSystem.Buildings.Rooms.FLEXLAB.Rooms.Examples;
model TestBedX3WithRadiantFloor
  ...
  Buildings.Rooms.FLEXLAB.Rooms.X3A.ClosetFullBed AClo(redeclare package Medium
      = Air, nPorts=1) "Closet in test cell X3A"
  ...
  parameter Buildings.Fluid.Data.Pipes.PEX_RADTEST pipe(dOut=0.015875, dIn=
        0.01905)
