within ChillerPlantSystem.Buildings.Rooms.FLEXLAB.Rooms.X3A;
model TestCellFullBed
  ...
  extends Buildings.Rooms.MixedAir(
    ...
    surBou(
      ...
      each absIR=0.9,
      each absSol=0.9,
      til={Buildings.HeatTransfer.Types.Tilt.Floor,Buildings.HeatTransfer.Types.Tilt.Floor,
          Buildings.HeatTransfer.Types.Tilt.Floor,Buildings.HeatTransfer.Types.Tilt.Floor,
    ...
    datConExt(
      ...
      til={Buildings.HeatTransfer.Types.Tilt.Wall,Buildings.HeatTransfer.Types.Tilt.Wall,
          Buildings.HeatTransfer.Types.Tilt.Ceiling,Buildings.HeatTransfer.Types.Tilt.Wall},
      azi={Buildings.HeatTransfer.Types.Azimuth.N,Buildings.HeatTransfer.Types.Azimuth.N,
          Buildings.HeatTransfer.Types.Azimuth.S,Buildings.HeatTransfer.Types.Azimuth.W}),
    datConBou(
      ...
      azi={Buildings.HeatTransfer.Types.Azimuth.W,Buildings.HeatTransfer.Types.Azimuth.N,
          Buildings.HeatTransfer.Types.Azimuth.N,Buildings.HeatTransfer.Types.Azimuth.N}),
    datConExtWin(
      layers={R16p8Wal},
      A={6.6675*3.6576},
      glaSys={glaSys},
