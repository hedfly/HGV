within ChillerPlantSystem.Buildings.Rooms.Constructions.Examples;
model ExteriorWallWithWindow "Test model for an exterior wall with a window"
  ...
  Buildings.Rooms.BaseClasses.ExteriorBoundaryConditionsWithWindow bouConExt(
    nCon=1,
    linearizeRadiation=linearizeRadiation,
  ...
  Buildings.HeatTransfer.Convection.Interior con[1](each A=A .- AWin, til={
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.ShadeRadiation intShaRad[1](
    ...
    each A=AGla) if glaSys.haveShade "Interior shade radiation model"
