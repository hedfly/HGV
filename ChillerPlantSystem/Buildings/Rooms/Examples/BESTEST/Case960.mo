...
model Case960 "Case 600, but with an unconditioned sun-space"
  ...
  parameter Buildings.Rooms.Examples.BESTEST.Data.ExteriorWallCase900 extWalCase900
    "Exterior wall"
    annotation (Placement(transformation(extent={{160,80},{174,94}})));

  parameter Buildings.Rooms.Examples.BESTEST.Data.FloorCase900 floorCase900 "Floor"
