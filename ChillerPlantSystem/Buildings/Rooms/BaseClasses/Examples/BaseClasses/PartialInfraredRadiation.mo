within ChillerPlantSystem.Buildings.Rooms.BaseClasses.Examples.BaseClasses;
...
protected
  Buildings.HeatTransfer.Sources.FixedTemperature bouConExt[NConExt](each T=
...
protected
  Buildings.HeatTransfer.Sources.FixedTemperature bouConExtWin[NConExtWin](
      each T=293.15) "Boundary condition" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={90,60})));
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature bouConBou[NConBou](each T=
        293.15) "Boundary condition" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={90,-60})));

  Buildings.HeatTransfer.Sources.FixedTemperature bouSurBou[NSurBou](each T=
        293.15) "Boundary condition" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={90,-90})));
