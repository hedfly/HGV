within ChillerPlantSystem.Buildings.Rooms.BaseClasses.Examples;
...
protected
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature bouGlaUns[NConExtWin](each T=
        288.15) "Boundary condition" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={70,-120})));
  Buildings.HeatTransfer.Sources.FixedTemperature bouGlaSha[NConExtWin](each T=
        284.15) "Boundary condition" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={70,-150})));
