within ChillerPlantSystem.Buildings.Airflow.Multizone;
model MediumColumn
...
equation
  ...
  rho = if (densitySelection == Buildings.Airflow.Multizone.Types.densitySelection.fromTop)
     then Medium.density(Medium.setState_phX(
    port_a.p,
    inStream(port_a.h_outflow),
    inStream(port_a.Xi_outflow))) else if (densitySelection == Buildings.Airflow.Multizone.Types.densitySelection.fromBottom)
     then Medium.density(Medium.setState_phX(
    port_b.p,
