...
model ReverseBuoyancy3Zones
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volEas(
    ...
    T_start=273.15 + 25,
    nPorts=5,
    m_flow_nominal=0.001) annotation (Placement(transformation(extent={{-32,-26},
            {-12,-6}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volOut(
    ...
    T_start=273.15 + 15,
    nPorts=2,
    m_flow_nominal=0.001) annotation (Placement(transformation(extent={{129,-30},
            {149,-10}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volWes(
    ...
    T_start=273.15 + 22,
    nPorts=3,
    m_flow_nominal=0.001) annotation (Placement(transformation(extent={{-164,-27},
            {-144,-7}}, rotation=0)));
