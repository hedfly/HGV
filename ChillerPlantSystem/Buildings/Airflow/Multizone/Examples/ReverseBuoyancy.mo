...
model ReverseBuoyancy
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volBotEas(
    ...
    T_start=273.15 + 25,
    nPorts=5,
    m_flow_nominal=0.001) "Volume of bottom floor, east room" annotation (
      Placement(transformation(extent={{-34,-30},{-14,-10}}, rotation=0)));
  ...
  Buildings.Fluid.Delays.DelayFirstOrder volBotWes(
    ...
    T_start=273.15 + 22,
    nPorts=3,
    p_start=101325) "Volume of bottom floor, west room" annotation (Placement(
        transformation(extent={{-161,-29},{-141,-9}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volTopEas(
    ...
    m_flow_nominal=0.001) "Volume of top floor, east room" annotation (
      Placement(transformation(extent={{-30,121},{-10,141}}, rotation=0)));
  Buildings.Fluid.MixingVolumes.MixingVolume volTopWes(
    ...
    m_flow_nominal=0.001) "Volume of top floor, west room" annotation (
      Placement(transformation(extent={{-110,120},{-90,140}}, rotation=0)));
