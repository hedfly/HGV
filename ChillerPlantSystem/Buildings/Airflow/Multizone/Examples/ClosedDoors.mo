...
model ClosedDoors "Model with three closed doors"
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volA(
    ...
    m_flow_nominal=0.01) annotation (Placement(transformation(extent={{-80,0},{
            -60,20}}, rotation=0)));
  Buildings.Fluid.MixingVolumes.MixingVolume volB(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    m_flow_nominal=0.01) annotation (Placement(transformation(extent={{40,40},{
            60,60}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volC(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    m_flow_nominal=0.01) annotation (Placement(transformation(extent={{70,-40},
            {90,-20}}, rotation=0)));
