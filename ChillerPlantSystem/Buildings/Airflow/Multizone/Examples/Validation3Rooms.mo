within ChillerPlantSystem.Buildings.Airflow.Multizone.Examples;
model Validation3Rooms
  ...
  Buildings.Airflow.Multizone.MediumColumn colEasInTop(
    ...
    h=1.5,
    densitySelection=Buildings.Airflow.Multizone.Types.densitySelection.fromBottom)
    annotation (Placement(transformation(extent={{121,-10},{141,10}}, rotation=
            0)));
  ...
  Buildings.Airflow.Multizone.MediumColumn colEasInBot(
    ...
    annotation (Placement(transformation(extent={{122,-70},{142,-50}}, rotation=
           0)));
  ...
  Buildings.Airflow.Multizone.MediumColumn colWesBot(
    ...
    h=1.5,
    densitySelection=Buildings.Airflow.Multizone.Types.densitySelection.fromBottom)
    annotation (Placement(transformation(extent={{-70,9},{-50,29}}, rotation=0)));
  ...
  Buildings.Airflow.Multizone.MediumColumn colWesTop(
    ...
    h=1.5,
    densitySelection=Buildings.Airflow.Multizone.Types.densitySelection.fromTop)
    annotation (Placement(transformation(extent={{-70,71},{-50,91}}, rotation=0)));
  Buildings.Airflow.Multizone.DoorDiscretizedOperable dooOpeClo(
    ...
    hA=3/2,
    hB=3/2,
    dp_turbulent(displayUnit="Pa") = 0.01) "Discretized door" annotation (
      Placement(transformation(extent={{-1,-55},{19,-35}}, rotation=0)));
  ...
  Buildings.Airflow.Multizone.MediumColumn col1EasBot(
    ...
    h=1.5,
    densitySelection=Buildings.Airflow.Multizone.Types.densitySelection.fromBottom)
    annotation (Placement(transformation(extent={{100,9},{120,29}}, rotation=0)));
  ...
  Buildings.Airflow.Multizone.MediumColumn colEasTop(
    ...
    h=1.5,
    densitySelection=Buildings.Airflow.Multizone.Types.densitySelection.fromTop)
    annotation (Placement(transformation(extent={{100,71},{120,91}}, rotation=0)));
