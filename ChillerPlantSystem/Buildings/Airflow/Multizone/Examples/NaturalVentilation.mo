...
model NaturalVentilation
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volA(
    ...
    T_start=273.15 + 18,
    nPorts=2,
    m_flow_nominal=0.001) annotation (Placement(transformation(extent={{-10,-20},
            {10,0}}, rotation=0)));
  ...
  Buildings.Airflow.Multizone.Orifice oriOutTop(
    ...
    A=0.1,
    m=0.5,
    dp_turbulent=0.1) annotation (Placement(transformation(extent={{23,40},{43,
            60}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volOut(
    ...
    T_start=273.15 + 20,
    nPorts=2,
    m_flow_nominal=0.001) annotation (Placement(transformation(extent={{53,-20},
            {73,0}}, rotation=0)));

  Buildings.HeatTransfer.Sources.PrescribedHeatFlow preHeaFlo annotation (
      Placement(transformation(extent={{-49,-20},{-29,0}}, rotation=0)));
