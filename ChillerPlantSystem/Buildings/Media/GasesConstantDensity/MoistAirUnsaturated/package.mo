within ChillerPlantSystem.Buildings.Media.GasesConstantDensity;
...
algorithm
  h :=
    ...
    T)*X[Water] +
    Buildings.Media.GasesConstantDensity.MoistAirUnsaturated.enthalpyOfDryAir(T)
    *(1.0 - X[Water]);
end enthalpyOfGas;
...
algorithm
  h := Buildings.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
    state.X);
...
redeclare function extends specificInternalEnergy "Specific internal energy"
  extends Modelica.Icons.Function;
algorithm
  u := Buildings.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
...
redeclare function extends specificGibbsEnergy "Specific Gibbs energy"
  extends Modelica.Icons.Function;
algorithm
  g := Buildings.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
...
redeclare function extends specificHelmholtzEnergy "Specific Helmholtz energy"
  extends Modelica.Icons.Function;
algorithm
  f := Buildings.Media.GasesConstantDensity.MoistAirUnsaturated.h_pTX(
    state.p,
    state.T,
