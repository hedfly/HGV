within ChillerPlantSystem.Buildings.Fluid.Chillers;
model Carnot
 ...
 extends Interfaces.FourPortHeatMassExchanger(
  ...
  parameter Buildings.Fluid.Types.EfficiencyInput effInpEva=Buildings.Fluid.Types.EfficiencyInput.volume
  ...
  parameter Buildings.Fluid.Types.EfficiencyInput effInpCon=Buildings.Fluid.Types.EfficiencyInput.port_a
  ...
  Modelica.SIunits.Temperature TEva_V
    "Evaporator temperature used to compute efficiency";
  Modelica.SIunits.Temperature TCon_V
    "Evaporator temperature used to compute efficiency";
protected
...
initial equation
  ...
  assert(abs(Buildings.Utilities.Math.Functions.polynomial(a=a, x=1) - 1) <
...
equation
  ...
  P = y * P_nominal;
  COPCar = TEva/Buildings.Utilities.Math.Functions.smoothMax(
    x1=1,
    x2=TCon - TEva,
    deltaX=0.25);
  ...
  TEva_V = vol2.heatPort.T;
  TCon_V = vol1.heatPort.T;
