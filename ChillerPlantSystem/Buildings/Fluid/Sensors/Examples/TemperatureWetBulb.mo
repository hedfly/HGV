...
model TemperatureWetBulb "Test model for the wet bulb temperature sensor"
 ...
 package Medium = Buildings.Media.PerfectGases.MoistAir "Medium model"
  ...
  Buildings.Fluid.Sources.Boundary_pT sin(
    ...
    use_p_in=true,
    nPorts=1,
    T=293.15) "Flow boundary condition" annotation (Placement(transformation(
          extent={{74,10},{54,30}}, rotation=0)));
  Buildings.Fluid.Sensors.TemperatureWetBulbTwoPort senWetBul(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    tau=0) "Wet bulb temperature sensor" annotation (Placement(transformation(
