...
model Density "Test model for the density sensor"
  ...
  Buildings.Fluid.Sources.Boundary_pT sin(
    ...
    nPorts=1) "Flow boundary condition" annotation (Placement(transformation(
          extent={{90,-40},{70,-20}}, rotation=0)));
  Buildings.Fluid.Sources.MassFlowSource_T masFloRat(
    redeclare package Medium = Medium,
    use_T_in=false,
    X={0.02,0.98},
    nPorts=1,
    use_m_flow_in=true) "Flow boundary condition" annotation (Placement(
  ...
  Buildings.Fluid.Sensors.DensityTwoPort senDenFlo(redeclare package Medium =
