...
model MixingBoxMinimumFlow
 ...
 package Medium = Buildings.Media.GasesConstantDensity.SimpleAir
  ...
  Buildings.Fluid.Actuators.Dampers.MixingBoxMinimumFlow mixBox(
    ...
    mExh_flow_nominal=1,
    dpExh_nominal=20,
    redeclare package Medium = Medium) "mixing box" annotation (Placement(
        transformation(extent={{14,-22},{34,-2}}, rotation=0)));
    Buildings.Fluid.Sources.Boundary_pT bouIn(
    redeclare package Medium = Medium,
    T=273.15 + 10,
    use_p_in=true,
    nPorts=3) annotation (Placement(transformation(extent={{-60,2},{-40,22}},
          rotation=0)));
