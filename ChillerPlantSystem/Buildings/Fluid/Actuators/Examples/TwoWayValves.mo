...
model TwoWayValves
  ...
  Buildings.Fluid.Sources.Boundary_pT sou(
    ...
    T=293.15) annotation (Placement(transformation(extent={{-70,-20},{-50,0}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin(
    redeclare package Medium = Medium,
    nPorts=3,
    p(displayUnit="Pa") = 3E5,
    T=293.15) annotation (Placement(transformation(extent={{72,-20},{52,0}},
          rotation=0)));
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage valEqu(
    ...
    "Valve model, equal percentage opening characteristics" annotation (
