within ChillerPlantSystem.Buildings.Fluid.Actuators.Examples;
model VAVBoxExponential
 ...
 package Medium = Buildings.Media.IdealGases.SimpleAir;
  ...
  Buildings.Fluid.Actuators.Dampers.Exponential dam(
    ...
    A=1.8,
    m_flow_nominal=2) annotation (Placement(transformation(extent={{20,10},{40,
            30}}, rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou(
    ...
    T=273.15 + 20,
    nPorts=2,
    use_p_in=true) annotation (Placement(transformation(extent={{-70,-20},{-50,
            0}}, rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin(
    redeclare package Medium = Medium,
    T=273.15 + 20,
    nPorts=2,
    use_p_in=true) annotation (Placement(transformation(extent={{72,-20},{52,0}},
          rotation=0)));
  ...
  Buildings.Fluid.Actuators.Dampers.VAVBoxExponential vav(
    ...
    dp_nominal=5,
    A=1.8,
    m_flow_nominal=2) annotation (Placement(transformation(extent={{-2,-50},{18,
            -30}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res(
    from_dp=true,
    m_flow_nominal=2,
    redeclare package Medium = Medium,
    dp_nominal=5 - 0.45*2^2/1.2/1.8^2/2) annotation (Placement(transformation(
          extent={{-36,10},{-16,30}}, rotation=0)));
