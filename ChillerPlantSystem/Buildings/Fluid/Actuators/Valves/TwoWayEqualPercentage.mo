within ChillerPlantSystem.Buildings.Fluid.Actuators.Valves;
...
equation
  if homotopyInitialization then
    phi = homotopy(actual=Buildings.Fluid.Actuators.BaseClasses.equalPercentage(
      y_actual,
      R,
      l,
      delta0), simplified=l + y_actual*(1 - l));
  else
    phi = Buildings.Fluid.Actuators.BaseClasses.equalPercentage(
      y_actual,
      R,
      l,
      delta0);
