within ChillerPlantSystem.Buildings.Fluid.Movers.Examples.BaseClasses;
partial model FlowMachine_ZeroFlow
  ...
  replaceable Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine floMacSta(
    ...
    dynamicBalance=false) constrainedby
  ...
  replaceable Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine floMacDyn(
      redeclare package Medium = Medium, energyDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial)
