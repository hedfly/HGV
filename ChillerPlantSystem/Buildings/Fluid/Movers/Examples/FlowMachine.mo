within ChillerPlantSystem.Buildings.Fluid.Movers.Examples;
model FlowMachine
  ...
  Buildings.Fluid.Movers.FlowMachinePolynomial fan(
    ...
    m_flow_nominal=10) annotation (Placement(transformation(extent={{0,-10},{20,
            10}}, rotation=0)));
  ...
  Buildings.Utilities.Reports.Printer printer(
    ...
    samplePeriod=0.1) annotation (Placement(transformation(extent={{16,-42},{36,
            -22}}, rotation=0)));
