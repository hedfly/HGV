within ChillerPlantSystem.Buildings.Fluid.Movers;
model FlowMachine_dp
  "Fan or pump with ideally controlled head dp as input signal"
  extends Buildings.Fluid.Movers.BaseClasses.ControlledFlowMachine(final
      control_m_flow=false, preSou(dp_start=dp_start, m_flow_small=m_flow_small));
