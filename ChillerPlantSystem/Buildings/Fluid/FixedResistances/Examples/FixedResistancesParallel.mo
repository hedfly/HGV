...
model FixedResistancesParallel
 ...
 package Medium = Buildings.Media.ConstantPropertyLiquidWater;
    ...
    deltaM=0.3,
    linearized=false,
    from_dp=false) annotation (Placement(transformation(extent={{-28,30},{-8,50}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou1(
    redeclare package Medium = Medium,
    T=293.15,
    nPorts=2,
    use_p_in=true) annotation (Placement(transformation(extent={{-70,28},{-50,
            48}}, rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin1(
    redeclare package Medium = Medium,
    T=283.15,
    nPorts=2,
    use_p_in=true) annotation (Placement(transformation(extent={{80,28},{60,48}},
          rotation=0)));
    ...
    deltaM=0.3,
    linearized=false,
    from_dp=false) annotation (Placement(transformation(extent={{-28,-10},{-8,
            10}}, rotation=0)));
  Buildings.Fluid.Sensors.MassFlowRate masFlo2(redeclare package Medium =
        Medium) "Mass flow rate sensor" annotation (Placement(transformation(
  ...
  Buildings.Fluid.Sensors.MassFlowRate masFlo1(redeclare package Medium =
        Medium) "Mass flow rate sensor" annotation (Placement(transformation(
