within ChillerPlantSystem.Buildings.Fluid.FixedResistances.Examples;
model FixedResistancesExplicit "Test of multiple resistances in series"
 ...
 package Medium = Buildings.Media.IdealGases.SimpleAir;
  Buildings.Fluid.Sources.Boundary_ph sou(
    ...
    use_p_in=true) annotation (Placement(transformation(extent={{-60,90},{-40,
            110}}, rotation=0)));
  Buildings.Fluid.Sources.Boundary_ph sin(
    redeclare package Medium = Medium,
    nPorts=1,
    use_p_in=false,
    p=101325) annotation (Placement(transformation(extent={{120,90},{100,110}},
          rotation=0)));
    ...
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) annotation (Placement(transformation(extent={{-20,90},{0,110}},
          rotation=0)));
  inner Modelica.Fluid.System system(p_ambient=101325)
    ...
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) annotation (Placement(transformation(extent={{20,90},{40,110}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res22(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) annotation (Placement(transformation(extent={{20,50},{40,70}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res21(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) annotation (Placement(transformation(extent={{-20,50},{0,70}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res31(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) annotation (Placement(transformation(extent={{-20,-20},{0,0}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res32(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5) annotation (Placement(transformation(extent={{20,-20},{40,0}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res42(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) annotation (Placement(transformation(extent={{20,-60},{40,-40}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res41(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true) annotation (Placement(transformation(extent={{-20,-60},{0,-40}},
          rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sin1(
    ...
    nPorts=2,
    use_p_in=false,
    p=101325) annotation (Placement(transformation(extent={{120,-40},{100,-20}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_ph sin2(
    redeclare package Medium = Medium,
    nPorts=1,
    use_p_in=false,
    p=101325) annotation (Placement(transformation(extent={{120,50},{100,70}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_ph sou1(
    redeclare package Medium = Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101335,
    use_p_in=true) annotation (Placement(transformation(extent={{-58,50},{-38,
            70}}, rotation=0)));
