...
model FixedResistance
 ...
 package Medium = Buildings.Media.ConstantPropertyLiquidWater;
  ...
  Buildings.Fluid.Sources.Boundary_pT sou1(
    ...
    use_p_in=true,
    T=293.15,
    nPorts=3) annotation (Placement(transformation(extent={{-60,-10},{-40,10}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin1(
    redeclare package Medium = Medium,
    T=283.15,
    use_p_in=true,
    nPorts=3) annotation (Placement(transformation(extent={{90,-10},{70,10}},
          rotation=0)));
    ...
    m_flow_nominal=5,
    dp_nominal=10,
    use_dh=true) annotation (Placement(transformation(extent={{-28,-10},{-8,10}},
          rotation=0)));
    ...
    m_flow_nominal=5,
    dp_nominal=10,
    use_dh=true) annotation (Placement(transformation(extent={{-28,-50},{-8,-30}},
          rotation=0)));
  ...
  Buildings.Fluid.Sensors.MassFlowRate masFlo3(redeclare package Medium =
        Medium) "Mass flow rate sensor" annotation (Placement(transformation(
