...
model Stratified "Test model for stratified tank"
 ...
 package Medium = Buildings.Media.ConstantPropertyLiquidWater "Medium model";
  ...
  Buildings.Fluid.Storage.StratifiedEnhanced tanEnh(
    ...
    nSeg=10,
    m_flow_nominal=0.1,
    VTan=3) "Tank" annotation (Placement(transformation(extent={{-18,-38},{2,-18}},
          rotation=0)));
  ...
  Buildings.Fluid.Sensors.EnthalpyFlowRate HOut_flow(redeclare package Medium
    ...
    annotation (Placement(transformation(extent={{6,2},{22,18}}, rotation=0)));
  Buildings.Fluid.Sensors.EnthalpyFlowRate HOut_flow1(redeclare package Medium
      = Medium, m_flow_nominal=0.1) "Enthalpy flow rate" annotation (Placement(
        transformation(extent={{18,-36},{34,-20}}, rotation=0)));
