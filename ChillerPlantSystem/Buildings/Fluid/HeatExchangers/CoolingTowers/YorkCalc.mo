within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.CoolingTowers;
model YorkCalc
  ...
  parameter
    Buildings.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters fanRelPow(r_V={0,
        0.1,0.3,0.6,1}, eta={0,0.1^3,0.3^3,0.6^3,1})
  ...
  Real FRWat "Ratio actual over design water mass flow ratio";
  Real FRAir "Ratio actual over design air mass flow ratio";
...
initial equation
  ...
  TApp_nominal =
    ...
    FRWat=FRWat0,
    FRAir=1);                              // this will be solved for FRWat0
