within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.CoolingTowers.Examples.BaseClasses;
partial model PartialStaticTwoPortCoolingTower
  ...
  replaceable
    ...
    show_T=true) "Cooling tower" annotation (Placement(transformation(extent={{
            24,-60},{44,-40}}, rotation=0)));
  Buildings.Fluid.Movers.FlowMachine_m_flow pum(
    redeclare package Medium = Medium_W,
    m_flow_nominal=mWat_flow_nominal,
    dynamicBalance=false,
    filteredSpeed=false) "Pump for chilled water loop" annotation (Placement(
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume vol(
    ...
    V=0.5) annotation (Placement(transformation(extent={{20,-120},{40,-100}})));
  Buildings.Fluid.Sources.FixedBoundary exp(redeclare package Medium = Medium_W,
