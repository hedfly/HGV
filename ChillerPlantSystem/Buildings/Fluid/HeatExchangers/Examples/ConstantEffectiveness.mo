...
model ConstantEffectiveness
 ...
 package Medium2 = Buildings.Media.GasesPTDecoupled.MoistAirUnsaturated;
  Buildings.Fluid.Sources.Boundary_pT sin_2(
    ...
    nPorts=1,
    T=273.15 + 10,
    X={0.001,0.999}) annotation (Placement(transformation(extent={{-58,-10},{-38,
            10}}, rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    ...
    p=300000,
    T=273.15 + 25)
    annotation (Placement(transformation(extent={{84,2},{64,22}}, rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    redeclare package Medium = Medium1,
    p=300000 + 5000,
    T=273.15 + 50,
    use_T_in=true,
    nPorts=1) annotation (Placement(transformation(extent={{-60,36},{-40,56}},
          rotation=0)));
