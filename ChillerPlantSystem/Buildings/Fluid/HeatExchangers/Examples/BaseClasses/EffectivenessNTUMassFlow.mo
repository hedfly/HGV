within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.Examples.BaseClasses;
partial model EffectivenessNTUMassFlow
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_2(
    ...
    T=T_a2_nominal) annotation (Placement(transformation(extent={{-42,14},{-22,
            34}}, rotation=0)));
  Buildings.Fluid.Sources.MassFlowSource_T sou_2(
    ...
    use_m_flow_in=true) annotation (Placement(transformation(extent={{138,14},{
            118,34}}, rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    redeclare package Medium = Medium1,
    use_p_in=false,
    p=300000,
    T=T_a1_nominal) annotation (Placement(transformation(extent={{140,50},{120,
            70}}, rotation=0)));
  Buildings.Fluid.Sources.MassFlowSource_T sou_1(
    redeclare package Medium = Medium1,
    use_m_flow_in=true,
    use_T_in=false,
    T=T_a1_nominal) annotation (Placement(transformation(extent={{-2,52},{18,72}},
          rotation=0)));
