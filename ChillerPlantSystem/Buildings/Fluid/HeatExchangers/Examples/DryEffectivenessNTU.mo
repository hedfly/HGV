within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.Examples;
model DryEffectivenessNTU
 ...
 parameter Modelica.SIunits.MassFlowRate m2_flow = m1_flow*cp1/
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_2(
    ...
    use_p_in=true,
    nPorts=5,
    T=273.15 + 10) annotation (Placement(transformation(extent={{-64,10},{-44,
            30}}, rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    ...
    nPorts=5,
    p=300000,
    T=273.15 + 25) annotation (Placement(transformation(extent={{80,40},{60,60}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    T=273.15 + 50,
    use_T_in=true,
    nPorts=5) annotation (Placement(transformation(extent={{-62,40},{-42,60}},
          rotation=0)));
  Buildings.Fluid.HeatExchangers.DryEffectivenessNTU hexPar(
    ...
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15) annotation (Placement(transformation(extent={{-10,40},
            {10,60}}, rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.DryEffectivenessNTU hexCou(
    ...
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15) annotation (Placement(transformation(extent={{-10,0},{
            10,20}}, rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.DryEffectivenessNTU hexCroC1Mix(
    ...
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15) annotation (Placement(transformation(extent={{-10,-28},
            {10,-8}}, rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.DryEffectivenessNTU hexCroC1Unm(
    ...
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15) annotation (Placement(transformation(extent={{-10,-58},
            {10,-38}}, rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.DryEffectivenessNTU hexCroUnm(
    ...
    show_T=true,
    T_a1_nominal=303.15,
    T_a2_nominal=293.15) annotation (Placement(transformation(extent={{-10,-86},
            {10,-66}}, rotation=0)));
