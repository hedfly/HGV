...
model DryEffectivenessNTUPControl
 ...
 package Medium2 = Buildings.Media.GasesPTDecoupled.SimpleAir;
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    nPorts=1,
    use_T_in=false,
    T=T_a1_nominal) annotation (Placement(transformation(extent={{-50,50},{-30,
            70}}, rotation=0)));
  ...
  Buildings.Controls.Continuous.LimPID P(
    ...
    Ti=30,
    k=0.1,
    Td=1) annotation (Placement(transformation(extent={{-24,80},{-4,100}},
          rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.DryEffectivenessNTU hex(
    ...
    dp2_nominal(displayUnit="Pa") = 200 + 100) annotation (Placement(
        transformation(extent={{60,16},{80,36}}, rotation=0)));
