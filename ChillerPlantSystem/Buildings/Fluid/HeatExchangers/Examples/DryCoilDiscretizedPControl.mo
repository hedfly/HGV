...
model DryCoilDiscretizedPControl
 ...
 package Medium2 = Buildings.Media.GasesPTDecoupled.SimpleAir;
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_2(
    ...
    T=303.15,
    nPorts=1) annotation (Placement(transformation(extent={{-52,10},{-32,30}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_2(
    ...
    T=T_a2_nominal) annotation (Placement(transformation(extent={{140,10},{120,
            30}}, rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    nPorts=1,
    use_T_in=false,
    T=T_a1_nominal) annotation (Placement(transformation(extent={{-52,50},{-32,
            70}}, rotation=0)));
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage val(
    ...
    dpValve_nominal=6000) "Valve model" annotation (Placement(transformation(
  ...
  Buildings.Fluid.HeatExchangers.DryCoilDiscretized hex(
    ...
    dp2_nominal(displayUnit="Pa") = 300) annotation (Placement(transformation(
  ...
  Buildings.Controls.Continuous.LimPID con(
    ...
    Td=60) "Controller" annotation (Placement(transformation(extent={{-20,90},{
            0,110}}, rotation=0)));
equation
