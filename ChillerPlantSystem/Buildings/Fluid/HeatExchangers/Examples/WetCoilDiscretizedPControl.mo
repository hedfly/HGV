...
model WetCoilDiscretizedPControl
 ...
 Buildings.Fluid.Sources.Boundary_pT sin_2(
    ...
    p=101325,
    T=303.15,
    nPorts=1) annotation (Placement(transformation(extent={{-58,-26},{-38,-6}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_2(
    ...
    T=293.15) annotation (Placement(transformation(extent={{160,8},{140,28}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    ...
    T=293.15,
    use_p_in=true,
    nPorts=1) annotation (Placement(transformation(extent={{160,40},{140,60}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    use_T_in=true,
    p=300000 + 7000,
    T=278.15) annotation (Placement(transformation(extent={{-24,38},{-4,58}},
          rotation=0)));
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort temSen(redeclare package Medium =
        ...
        transformation(extent={{40,-26},{20,-6}}, rotation=0)));
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val(
    redeclare package Medium = Medium1,
    m_flow_nominal=m1_flow_nominal,
    filteredOpening=false,
    dpFixed_nominal=2000,
    dpValve_nominal=5000) annotation (Placement(transformation(extent={{18,38},
            {38,58}}, rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.WetCoilDiscretized hex(
    ...
    dp1_nominal(displayUnit="Pa") = 0) annotation (Placement(transformation(
          extent={{60,16},{80,36}}, rotation=0)));
