within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.BaseClasses.Examples;
model Manifold "Test model for coil manifold"
 ...
 parameter Integer nPipSeg = 4 "Number of pipe segments";
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    ...
    use_p_in=true,
    T=283.15,
    nPorts=2) annotation (Placement(transformation(extent={{172,22},{152,42}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    p=101335,
    T=293.15,
    nPorts=2) annotation (Placement(transformation(extent={{-60,22},{-40,42}},
          rotation=0)));
  ...
  Buildings.Fluid.Sensors.MassFlowRate[nPipPar] mfr_1(redeclare each package
      Medium = Medium) annotation (Placement(transformation(extent={{30,24},{50,
            44}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.Ramp P(
    ...
    offset=101305) annotation (Placement(transformation(extent={{-100,60},{-80,
            80}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.BaseClasses.PipeManifoldFixedResistance pipFixRes_1(
    redeclare package Medium = Medium,
    nPipPar=nPipPar,
    m_flow_nominal=5,
    dp_nominal=10,
    linearized=false,
    mStart_flow_a=5) annotation (Placement(transformation(extent={{-30,24},{-10,
            44}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.BaseClasses.PipeManifoldNoResistance pipNoRes_1(
    redeclare package Medium = Medium,
    nPipPar=nPipPar,
    mStart_flow_a=5) annotation (Placement(transformation(extent={{114,24},{94,
            44}}, rotation=0)));
  ...
  Buildings.Fluid.Sensors.MassFlowRate[nPipPar,nPipSeg] mfr_2(redeclare each
      package Medium = Medium) annotation (Placement(transformation(extent={{30,
            -76},{50,-56}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.BaseClasses.DuctManifoldFixedResistance ducFixRes_2(
    redeclare package Medium = Medium,
    nPipPar=nPipPar,
    nPipSeg=nPipSeg,
    m_flow_nominal=5,
    dp_nominal=10,
    linearized=false,
    mStart_flow_a=5) annotation (Placement(transformation(extent={{-32,-76},{-12,
            -56}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.BaseClasses.DuctManifoldNoResistance ducNoRes_2(
    redeclare package Medium = Medium,
    nPipPar=nPipPar,
    nPipSeg=nPipSeg,
    mStart_flow_a=5) annotation (Placement(transformation(extent={{116,-76},{96,
            -56}}, rotation=0)));
