...
model HexElementLatent
 ...
 package Medium_A = Buildings.Media.PerfectGases.MoistAirUnsaturated;
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_2(
    ...
    use_T_in=true,
    T=283.15,
    nPorts=1) annotation (Placement(transformation(extent={{40,-80},{60,-60}},
          rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    ...
    use_p_in=true,
    T=288.15,
    nPorts=1) annotation (Placement(transformation(extent={{42,40},{62,60}},
          rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    nPorts=1,
    p=101340,
    T=293.15) annotation (Placement(transformation(extent={{-60,40},{-40,60}},
          rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.BaseClasses.HexElementLatent hex(
    ...
    energyDynamics2=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
