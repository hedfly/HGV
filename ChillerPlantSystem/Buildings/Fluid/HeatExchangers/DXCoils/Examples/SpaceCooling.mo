within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.DXCoils.Examples;
model SpaceCooling "Space cooling with DX coils"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.Data.Generic.DXCoil datCoiMulSpe(nSta=2,
      sta={
        Buildings.Fluid.HeatExchangers.DXCoils.Data.Generic.BaseClasses.Stage(
        spe=900/60,
        nomVal=
