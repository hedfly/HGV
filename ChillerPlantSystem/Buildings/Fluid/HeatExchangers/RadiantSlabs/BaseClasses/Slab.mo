within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses;
partial model Slab "Base class for radiant slab"
  ...
  parameter Buildings.Fluid.Data.Pipes.Generic pipe
    "Record for pipe geometry and material" annotation (choicesAllMatching=true,
