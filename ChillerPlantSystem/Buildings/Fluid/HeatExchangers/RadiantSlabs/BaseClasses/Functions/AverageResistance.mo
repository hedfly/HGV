within ChillerPlantSystem.Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses.Functions;
function AverageResistance
  ...
  input
    Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses.Types.SystemType sysTyp
...
algorithm
  ...
  elseif sysTyp == Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses.Types.SystemType.Ceiling_Wall_or_Capillary then
    ...
    assert(sysTyp == Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses.Types.SystemType.Floor
       or sysTyp == Buildings.Fluid.HeatExchangers.RadiantSlabs.BaseClasses.Types.SystemType.Ceiling_Wall_or_Capillary,
