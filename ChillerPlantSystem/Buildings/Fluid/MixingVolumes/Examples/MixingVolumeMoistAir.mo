...
model MixingVolumeMoistAir
  ...
  Buildings.HeatTransfer.Sources.PrescribedHeatFlow preHeaFlo annotation (
      Placement(transformation(extent={{36,120},{56,140}}, rotation=0)));
  ...
  Buildings.Utilities.Psychrometrics.TDewPoi_pW dewPoi "Dew point temperature"
    annotation (Placement(transformation(extent={{12,-120},{32,-100}}, rotation=
           0)));
  ...
  Buildings.Controls.Continuous.LimPID PI(
    ...
    wd=0,
    yMin=-1000) annotation (Placement(transformation(extent={{-40,120},{-20,140}},
          rotation=0)));
  ...
  inner Modelica.Fluid.System system
    ...
    from_dp=true,
    dp_nominal=2.5,
    m_flow_nominal=m_flow_nominal) annotation (Placement(transformation(extent=
            {{120,-10},{140,10}}, rotation=0)));
equation
