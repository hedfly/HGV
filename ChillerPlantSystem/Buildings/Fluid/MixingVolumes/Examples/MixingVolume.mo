within ChillerPlantSystem.Buildings.Fluid.MixingVolumes.Examples;
model MixingVolume
  ...
  Buildings.Fluid.Sources.Boundary_pT sin(
    ...
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5) annotation (Placement(transformation(extent={{-36,50},{-16,
            70}}, rotation=0)));
  MixingVolumes.MixingVolume vol1(
    ...
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5) annotation (Placement(transformation(extent={{80,50},{100,
            70}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res11(
    redeclare each package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5) annotation (Placement(transformation(extent={{-40,0},{-20,
            20}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res12(
    redeclare each package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5) annotation (Placement(transformation(extent={{80,0},{100,20}},
          rotation=0)));
  Modelica.Fluid.Vessels.ClosedVolume vol(
    ...
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
         annotation (Placement(transformation(extent={{0,60},{22,80}}, rotation=
           0)));
  Buildings.Utilities.Diagnostics.AssertEquality assertEquality annotation (
      Placement(transformation(extent={{160,72},{180,92}}, rotation=0)));
  Buildings.Fluid.Sensors.EnthalpyFlowRate entFloRat(redeclare package Medium
      = Medium, m_flow_nominal=2) "Enthalpy flow rate" annotation (Placement(
  ...
  Buildings.Fluid.MixingVolumes.MixingVolumeMoistAir vol2(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    m_flow_nominal=2) annotation (Placement(transformation(extent={{0,-82},{20,
            -62}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res21(
    redeclare each package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5) annotation (Placement(transformation(extent={{-40,-92},{-20,
            -72}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res22(
    redeclare each package Medium = Medium,
    from_dp=true,
    m_flow_nominal=2,
    dp_nominal=2.5) annotation (Placement(transformation(extent={{80,-92},{100,
            -72}}, rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality assertEquality1 annotation (
      Placement(transformation(extent={{156,10},{176,30}}, rotation=0)));
  Buildings.Fluid.Sensors.EnthalpyFlowRate entFloRat2(redeclare package Medium
      = Medium, m_flow_nominal=2) "Enthalpy flow rate" annotation (Placement(
        transformation(extent={{40,-92},{60,-72}}, rotation=0)));
