within ChillerPlantSystem.Buildings.Fluid.SolarCollectors.Examples;
model FlatPlateWithTank
  ...
  Buildings.Fluid.Storage.StratifiedEnhancedInternalHex tan(
    ...
    T_start=293.15,
    TTan_nominal=293.15,
    THex_nominal=323.15) "Storage tank model" annotation (Placement(
        transformation(
        extent={{-15,-15},{15,15}},
        rotation=0,
        origin={27,-33})));
  ...
  Buildings.Fluid.Storage.ExpansionVessel exp(
    ...
    VTot=0.1,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Expansion tank in the system" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-60,-48})));
