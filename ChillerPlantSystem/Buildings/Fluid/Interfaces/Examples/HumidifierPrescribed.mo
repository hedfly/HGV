within ChillerPlantSystem.Buildings.Fluid.Interfaces.Examples;
model HumidifierPrescribed
 ...
 parameter Modelica.SIunits.MassFlowRate mWat_flow_nominal = 0.001
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    T=293.15) annotation (Placement(transformation(extent={{-168,92},{-148,112}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_11(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,92},
            {-80,112}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_12(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,134},
            {-80,154}}, rotation=0)));
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    redeclare package Medium = Medium,
    use_p_in=true,
    T=288.15,
    nPorts=4) annotation (Placement(transformation(extent={{-168,134},{-148,154}},
          rotation=0)));
  ...
  Humidifier hea3(
    ...
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,12},
            {-80,32}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_3(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,54},
            {-80,74}}, rotation=0)));
  Humidifier hea4(
    redeclare package Medium = Medium,
    m_flow_nominal=0.5,
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass1(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,140},{180,160}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y2(y=hea1.staB.T)
    annotation (Placement(transformation(extent={{40,130},{140,150}}, rotation=
            0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass2(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,100},{180,120}},
          rotation=0)));
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass3(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,38},{180,58}},
          rotation=0)));
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass4(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,-2},{180,18}},
          rotation=0)));
  ...
  Humidifier hea5(redeclare package Medium =
    ...
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-110},
            {-80,-90}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_5(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-68},
            {-80,-48}}, rotation=0)));
  ...
  Humidifier hea7(redeclare package Medium =
    ...
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-190},
            {-80,-170}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_7(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-148},
            {-80,-128}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume mix2(
    ...
    m_flow_nominal=0.5,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
      Placement(transformation(extent={{-20,-180},{0,-160}}, rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass5(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,-62},{180,-42}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y10(
    ...
    annotation (Placement(transformation(extent={{40,-72},{140,-52}}, rotation=
            0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass6(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,-102},{180,-82}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y12(
    ...
    annotation (Placement(transformation(extent={{40,-112},{140,-92}}, rotation=
           0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass7(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,-164},{180,-144}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y14(
    ...
    annotation (Placement(transformation(extent={{40,-174},{140,-154}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass8(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,-204},{180,-184}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y16(
    ...
    annotation (Placement(transformation(extent={{40,-214},{140,-194}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass9(startTime=0.3, threShold=
        0.05) annotation (Placement(transformation(extent={{160,-300},{180,-280}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y18(y=hea5.staB.T)
    annotation (Placement(transformation(extent={{40,-310},{140,-290}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass10(startTime=0.3, threShold=
       0.05) annotation (Placement(transformation(extent={{160,-260},{180,-240}},
          rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y20(y=hea7.staA.T)
    annotation (Placement(transformation(extent={{40,-270},{140,-250}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass11(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,140},{
            360,160}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y22(y=hea1.staB.X[1])
    annotation (Placement(transformation(extent={{220,130},{320,150}}, rotation=
           0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass12(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,100},{
            360,120}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y24(
    ...
    annotation (Placement(transformation(extent={{220,90},{320,110}}, rotation=
            0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass13(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,38},{360,
            58}}, rotation=0)));
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass14(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-2},{360,
            18}}, rotation=0)));
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass15(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-62},{
            360,-42}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y30(
    ...
    annotation (Placement(transformation(extent={{220,-72},{320,-52}}, rotation=
           0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass16(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-102},{
            360,-82}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y32(
    ...
    annotation (Placement(transformation(extent={{220,-112},{320,-92}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass17(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-164},{
            360,-144}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y34(
    ...
    annotation (Placement(transformation(extent={{220,-174},{320,-154}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass18(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-204},{
            360,-184}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y36(
    ...
    annotation (Placement(transformation(extent={{220,-214},{320,-194}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass19(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-300},{
            360,-280}}, rotation=0)));
  ...
  Modelica.Blocks.Sources.RealExpression y38(y=hea5.staB.X[1])
    annotation (Placement(transformation(extent={{220,-310},{320,-290}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass20(threShold=1E-2,
      startTime=0.3) annotation (Placement(transformation(extent={{340,-260},{
            360,-240}}, rotation=0)));
