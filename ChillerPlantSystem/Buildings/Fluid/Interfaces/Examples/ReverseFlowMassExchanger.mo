...
package Medium = Buildings.Media.PerfectGases.MoistAir;
  ...
  Buildings.Fluid.Sources.FixedBoundary sink2(redeclare package Medium = Medium,
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source1(
    ...
    T(displayUnit="degC") = 293.15)
        ...
        rotation=0,
        origin={-150,100})));
  Buildings.Fluid.Sources.FixedBoundary sink1(redeclare package Medium = Medium,
      nPorts=2) "Fluid sink" annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={40,98})));
