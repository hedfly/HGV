...
model HeaterCoolerPrescribed
 ...
 package Medium = Buildings.Media.ConstantPropertyLiquidWater;
  ...
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea1(
    ...
    "Heater and cooler" annotation (Placement(transformation(extent={{-14,90},{
            6,110}}, rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    ...
    T=293.15) annotation (Placement(transformation(extent={{-170,90},{-150,110}},
          rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_11(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,90},
            {-80,110}}, rotation=0)));
  ...
  Buildings.Fluid.Sources.Boundary_pT sin_1(
    ...
    use_p_in=true,
    T=288.15,
    nPorts=4) annotation (Placement(transformation(extent={{-168,132},{-148,152}},
          rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea2(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{28,134},{
            48,154}}, rotation=0)));
  ...
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea3(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{-14,-30},
            {6,-10}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_2(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-30},
            {-80,-10}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_3(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,22},
            {-80,42}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea4(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{20,22},{
            40,42}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume mix1(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
      Placement(transformation(extent={{62,-20},{82,0}}, rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass1(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,160},{180,180}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass2(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,116},{180,136}},
          rotation=0)));
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea5(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{-10,-190},
            {10,-170}}, rotation=0)));
    ...
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-130},
            {-80,-110}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea6(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{0,-130},{
            20,-110}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea7(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{-10,-330},
            {10,-310}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_6(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-330},
            {-80,-310}}, rotation=0)));
    Buildings.Fluid.FixedResistances.FixedResistanceDpM res_7(
    redeclare package Medium = Medium,
    dp_nominal=5,
    m_flow_nominal=0.5) annotation (Placement(transformation(extent={{-100,-270},
            {-80,-250}}, rotation=0)));
  Buildings.Fluid.HeatExchangers.HeaterCoolerPrescribed hea8(
    ...
    dp_nominal=200,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Heater and cooler" annotation (Placement(transformation(extent={{0,-270},{
            20,-250}}, rotation=0)));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume mix2(
    ...
    m_flow_nominal=0.5,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
      Placement(transformation(extent={{60,-320},{80,-300}}, rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass9(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,-400},{180,-380}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass10(threShold=0.05,
      startTime=600) annotation (Placement(transformation(extent={{160,-360},{
            180,-340}}, rotation=0)));
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass3(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,0},{180,20}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass4(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,60},{180,80}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass5(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,-164},{180,-144}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass6(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,-100},{180,-80}},
          rotation=0)));
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass7(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,-284},{180,-264}},
          rotation=0)));
  Buildings.Utilities.Diagnostics.AssertEquality ass8(threShold=0.05, startTime=
       600) annotation (Placement(transformation(extent={{160,-240},{180,-220}},
          rotation=0)));
