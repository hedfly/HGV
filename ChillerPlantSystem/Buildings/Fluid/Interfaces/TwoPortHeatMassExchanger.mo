...
model TwoPortHeatMassExchanger
  ...
  extends Buildings.Fluid.Interfaces.PartialTwoPortInterface(port_a(h_outflow(
  ...
  replaceable Buildings.Fluid.MixingVolumes.MixingVolume vol constrainedby
    ...
    final C_start=C_start) "Volume for fluid stream" annotation (Placement(
        transformation(extent={{-9,0},{11,-20}}, rotation=0)));
