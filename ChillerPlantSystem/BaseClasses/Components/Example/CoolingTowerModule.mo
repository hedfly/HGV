...
model CoolingTowerModule
  ...
  ChillerPlantSystem.BaseClasses.Components.CoolingTowerModule
    ...
    eta=eta,
    redeclare package MediumCW = MediumCW) "Single cooling tower module"
...
equation
  ...
  annotation (__Dymola_Commands(file=
          "Resources\Scripts\Dymola\BaseClasses\Components\Example\CoolingTowerModule.mos"
        "Simulate and plot"),
